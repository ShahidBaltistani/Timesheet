(function(e) { "function" == typeof define && define.amd ? define(["jquery", "moment"], e) : e(jQuery, moment) })(
    function(e, t) {
        ...
        (t.defineLocale || t.lang).call(t,
            "pl",
            {
                months: function(e, t) { return/D MMMM/.test(t) ? a[e.month()] : i[e.month()] },
                ...
                ordinal: "%d.",
                week: { dow: 1, doy: 4 }
            }), e.fullCalendar.datepickerLang("pl",
            "pl",
            {
                closeText: "Zamknij",
                prevText: "&#x3C;Poprzedni",
            ...
            {
                defaultButtonText: { month: "Miesiąc", week: "Tydzień", day: "Dzień", list: "Plan dnia" },
