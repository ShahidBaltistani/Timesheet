define("echarts/chart/gauge",
    [
        "require", "./base", "../util/shape/GaugePointer", "zrender/shape/Text", "zrender/shape/Line",
        "zrender/shape/Rectangle", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData",
        "../util/accMath", "zrender/tool/util", "../chart"
    ],
    function(e) {
        ...
        return t.prototype = {
            ...
            _buildShape: function() {
                ...
                for (var t = 0, i = e.length; i > t; t++)
                    ...
                    (this.selectedMap[e[t].name] = !0, e[t] = this.reformOption(e[t]), this.legendHoverLink =
                        e[t].legendHoverLink || this.legendHoverLink, this._buildSingleGauge(t), this.buildMark(t));
                this.addShapeList();
            },
                ...
                this._paramsMap[e] =
                    {
                        ...
                        this._paramsMap[e].startAngle - this._paramsMap[e].endAngle, this._colorMap(e),
                    this._buildAxisLine(e), this._buildSplitLine(e), this._buildAxisTick(e), this._buildAxisLabel(e),
                    this._buildPointer(e), this._buildTitle(e), this._buildDetail(e);
            },
            _buildAxisLine: function(e) {
                ...
                if (t.axisLine.show)
                    for (var i,
                        ...
                        h = r.totalAngle,
                        V = r.colorArray,
                        U = t.axisLine.lineStyle,
                        d = this.parsePercent(U.width, r.radius[1]),
                        p = r.radius[1],
                        c = p - d,
                        u = l,
                        y = 0,
                        ...
                        g > y;
                        y++)
                        n = l - h * (V[y][0] - a) / o, i = this._getSector(s, c, p, n, u, V[y][1], U), u =
                            n, i._animationAdd =
                            "r", m.set(i, "seriesIndex", e), m.set(i, "dataIndex", y), this.shapeList.push(i);
            },
            _buildSplitLine: function(e) {
                ...
                if (t.splitLine.show)
                    for (var i,
                        ...
                        h = t.max - l,
                        m = t.splitLine,
                        V = this.parsePercent(m.length, r.radius[1]),
                        U = m.lineStyle,
                        d = U.color,
                        p = r.center,
                        c = r.startAngle * Math.PI / 180,
                        u = r.totalAngle * Math.PI / 180,
                        y = r.radius[1],
                        g = y - V,
                        b = 0;
                        s >= b;
                        b++)
                        i = c - u / s * b, n = Math.sin(i), a = Math.cos(i), this.shapeList.push(new o({
            ...
            _buildAxisTick: function(e) {
                ...
                if (t.axisTick.show)
                    for (var i,
                        ...
                        m = t.axisTick,
                        V = m.splitNumber,
                        U = this.parsePercent(m.length, r.radius[1]),
                        d = m.lineStyle,
                        p = d.color,
                        c = r.center,
                        u = r.startAngle * Math.PI / 180,
                        y = r.totalAngle * Math.PI / 180,
                        g = r.radius[1],
                        b = g - U,
                        f = 0,
                        k = s * V;
                        ...
                        f++)
                        f % V !== 0 &&
                        (i = u - y / k * f, n = Math.sin(i), a = Math.cos(i), this.shapeList.push(new o({
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase() + 1,
                            hoverable: !1,
                            style: {
            ...
            _buildAxisLabel: function(e) {
                ...
                if (t.axisLabel.show)
                    for (var i,
                        ...
                        u = p.startAngle,
                        y = p.totalAngle,
                        g = p.radius[1] - this.parsePercent(t.splitLine.length, p.radius[1]) - 5,
                        b = 0;
                        s >= b;
                        b++)
                        r = V.accAdd(l, V.accMul(V.accDiv(h, s), b)), i = u - y / s * b, n =
                            Math.sin(i * Math.PI / 180), o = Math.cos(i * Math.PI / 180), i =
                            (i + 360) % 360, this.shapeList.push(new a({
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase() + 1,
                            hoverable: !1,
                            style: {
            ...
            _buildPointer: function(e) {
                ...
                if (t.pointer.show) {
                    ...
                    m.pack(p, this.series[e], e, this.series[e].data[0], 0, this.series[e].data[0].name, V),
                        this.shapeList.push(p), this.shapeList.push(new s({
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase() + 2,
                            hoverable: !1,
                ...
                if (t.title.show) {
                    ...
                    if ("" !== n) {
                        ...
                        this.shapeList.push(new a({
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase() +
                                (Math.abs(m - h.center[0]) + Math.abs(V - h.center[1]) < 2 * s.fontSize ? 2 : 1),
                            hoverable: !1,
                            style: {
                                x: m,
                                y: V,
            ...
            _buildDetail: function(e) {
                ...
                if (t.detail.show) {
                    ...
                    this.shapeList.push(new r({
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() +
                        (Math.abs(m + i.width / 2 - l.center[0]) + Math.abs(V + i.height / 2 - l.center[1]) <
                            o.fontSize
                            ? 2
                            : 1),
                        hoverable: !1,
            ...
            _getValue: function(e) { return this.getDataFromOption(this.series[e].data[0]) },
            ...
            _getSector: function(e, t, i, n, a, o, r) {
                return new l({
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
    ...
    function(e) {
        ...
        return t.prototype = {
            ...
            buildPath: function(e, t) {
                ...
                a = t.angle - Math.PI / 2, e.moveTo(o, r), e.lineTo(t.x + Math.cos(a) * n, t.y - Math.sin(a) * n),
                    e.lineTo(t.x + Math.cos(t.angle) * i, t.y - Math.sin(t.angle) * i), e.lineTo(t.x - Math.cos(a) * n,
                        t.y + Math.sin(a) * n), e.lineTo(o, r);
            },
            getRect: function(e) {
                if (e.__rect) return e.__rect;
                var t = 2 * e.width, i = e.x, n = e.y, a = i + Math.cos(e.angle) * e.r, o = n - Math.sin(e.angle) * e.r;
                return e.__rect =
                {
                    x: Math.min(i, a) - t,
                    y: Math.min(n, o) - t,
