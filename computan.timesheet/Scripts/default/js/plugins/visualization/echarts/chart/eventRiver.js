define("echarts/chart/eventRiver",
    [
        "require", "./base", "../layout/eventRiver", "zrender/shape/Polygon", "../component/axis", "../component/grid",
        "../component/dataZoom", "../config", "../util/ecData", "../util/date", "zrender/tool/util",
    ...
    function(e) {
        function t(e, t, n, a, o) {
            ...
            var r = this;
            r._ondragend = function() { r.isDragend = !0 }, this.refresh(a);
        }
        ...
        return t.prototype = {
            ...
            _buildShape: function() {
                ...
                for (var t = this.component.legend, i = [], a = 0; a < e.length; a++)
                    if (e[a].type === this.type) {
                        e[a] = this.reformOption(e[a]), this.legendHoverLink =
                    ...
                    if (i[n].type === this.type) {
                        ...
                        for (var o = 0, r = i[n].data.length; r > o; o++) {
                            ...
                            for (var l = 0, h = t.length; h > l; l++)
                                t[l].timeScale = e.getCoord(s.getNewDate(t[l].time) - 0), t[l].valueScale =
                                    Math.pow(t[l].value, .8);
                        }
                    }
            ...
            _drawEventBubble: function(e, t, i) {
                ...
                g = new a(g), this.addLabel(g, o, l, e.name), r.pack(g, n[t], t, n[t].data[i], i, n[t].data[i].name),
            ...
            _calculateControlPoints: function(e) {
                ...
                if (!(1 > a)) {
                    ...
                    for (l.push([(o[s] + (o[s] + t)) / 2, r[s] / -2 + i]), l.push([o[s] + t, i]), l.push([
                            (o[s] + (o[s] + t)) / 2, r[s] / 2 + i
                        ]), s = a - 1;
                        s > 0;
                        s--) l.push([(o[s] + o[s - 1]) / 2, r[s - 1] / 2 + i]);
                    return l;
                }
            },
    ...
    }), define("echarts/layout/eventRiver",
    ["require"],
    function() {
        function e(e, o, r) {
            function s(e, t) {
            ...
            for (var h = 5, m = o, V = 0; V < e.length; V++) {
                for (var U = 0; U < e[V].data.length; U++) {
                    ...
                    for (var d = 0, p = 0; p < e[V].data[U].evolution.length; p++)
                        d += e[V].data[U].evolution[p].valueScale;
            ...
            e.sort(s);
            for (var c = Number.MAX_VALUE, u = 0, V = 0; V < e.length; V++)
                for (var U = 0; U < e[V].data.length; U++)
                    for (var p = 0; p < e[V].data[U].evolution.length; p++) {
                        var y = e[V].data[U].evolution[p].timeScale;
                        c = Math.min(c, y), u = Math.max(u, y);
                    }
            for (var g = i(Math.floor(c), Math.ceil(u)), b = 0, V = 0; V < e.length; V++)
                for (var U = 0; U < e[V].data.length; U++) {
                    var f = e[V].data[U];
                    f.time = [], f.value = [];
                    for (var p = 0; p < e[V].data[U].evolution.length; p++)
                        f.time.push(e[V].data[U].evolution[p].timeScale), f.value.push(e[V].data[U].evolution[p]
                            .valueScale);
                    ...
                    for (f.y - f.value[p] / 2 - h < _ && (f.y = _ + f.value[p] / 2 + h), e[V].y = f.y, b =
                            Math.max(b, f.y + f.value[k] / 2), p = 0;
                        p < f.time.length - 1;
                        p++) a(g, f.time[p], f.time[p + 1], f.y + f.value[p] / 2);
        ...
        function n(e, t, i) {
            ...
            if (t == e.left && i == e.right) o = e.maxValue;
            else if (a >= i && null != e.leftChild) o = n(e.leftChild, t, i);
            else if (t >= a && null != e.rightChild) o = n(e.rightChild, t, i);
            else {
                var r = 0, s = 0;
                null != e.leftChild && (r = n(e.leftChild, t, a)), null != e.rightChild && (s = n(e.rightChild, a, i)),
                    o = r > s ? r : s;
            }
            return o;
        }
        ...
        function a(e, t, i, n) {
            if (null != e) {
                ...
                e.maxValue =
                    e.maxValue > n ? e.maxValue : n, (Math.floor(10 * t) != Math.floor(10 * e.left) ||
                        Math.floor(10 * i) != Math.floor(10 * e.right)) &&
                    (o >= i
                        ? a(e.leftChild, t, i, n)
                        : t >= o
                        ? a(e.rightChild, t, i, n)
                        : (a(e.leftChild, t, o, n), a(e.rightChild, o, i, n)));
            }
        }
