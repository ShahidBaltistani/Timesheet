define("echarts/chart/tree",
    [
        "require", "./base", "zrender/tool/area", "zrender/tool/vector", "../util/shape/Icon", "zrender/shape/Image",
        "zrender/shape/Line", "zrender/shape/BezierCurve", "../layout/Tree", "../data/Tree", "../config",
        "../util/ecData", "zrender/config", "zrender/tool/event", "zrender/tool/util", "../chart"
    ],
    function(e) {
        ...
        var i = e("./base"),
            n = .618,
            a = (e("zrender/tool/area"), e("zrender/tool/vector"), e("../util/shape/Icon")),
        ...
        return t.prototype = {
            ...
            _buildShape: function(e, t) {
                var i = e.data[0];
                this.tree = h.fromOptionData(i.name, i.children), this.tree.root.data =
                    i, this._setTreeShape(e), this.tree.traverse(function(i) {
                        this._buildItem(i, e, t), i.children.length > 0 && this._buildLink(i, e);
                    },
                    this);
                var n = e.roam === !0 || "move" === e.roam, a = e.roam === !0 || "scale" === e.roam;
                this.zr.modLayer(this.getZlevelBase(), { panable: n, zoomable: a }),
                    (this.query("markPoint.effect.show") || this.query("markLine.effect.show")) &&
                        this.zr.modLayer(m.EFFECT_ZLEVEL, { panable: n, zoomable: a }), this.addShapeList();
            },
            _buildItem: function(e, t, i) {
                ...
                c.style.iconType.match("image") &&
                    (c.style.image = c.style.iconType.replace(new RegExp("^image:\\/\\/"), ""), c = new o({
                        rotation: p,
                        style: c.style,
                        ...
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase()
                    })), this.deepQuery(n, "itemStyle.normal.label.show") &&
                    (c.style.text = null == e.data.label ? e.id : e.data.label, c.style.textPosition =
                        this.deepQuery(n, "itemStyle.normal.label.position"), "radial" === t.orient &&
                        "inside" !== c.style.textPosition &&
                        (c.style.textPosition = d), c.style.textColor =
                        this.deepQuery(n, "itemStyle.normal.label.textStyle.color"), c.style.textFont =
                        this.getFont(this.deepQuery(n, "itemStyle.normal.label.textStyle") || {})),
                    this.deepQuery(n, "itemStyle.emphasis.label.show") &&
                    (c.highlightStyle.textPosition =
                        this.deepQuery(n, "itemStyle.emphasis.label.position"), c.highlightStyle.textColor =
                        this.deepQuery(n, "itemStyle.emphasis.label.textStyle.color"), c.highlightStyle.textFont =
                        this.getFont(this.deepQuery(n, "itemStyle.emphasis.label.textStyle") || {})), V.pack(c,
                        t,
                        i,
                        e.data,
                        0,
                        e.id), this.shapeList.push(c);
            },
            ...
            _buildBrokenLine: function(e, t, i) {
                ...
                if ("horizontal" === l) {
                    ...
                    m = r + (y - r) * (1 - n), V = s, d = m, p = e.children[0].layout.position[1], c = m, u =
                        e.children[e.children.length - 1].layout.position[1];
                }
                o.push(this._getLine(r, s, m, V, a)), o.push(this._getLine(d, p, c, u, a));
                for (var g = 0; g < e.children.length; g++)
                    y = e.children[g].layout.position[0], h =
                        e.children[g].layout.position[1], "horizontal" === l ? p = h : d = y, o.push(this._getLine(d,
                        p,
                        y,
                        h,
                        a));
            ...
            _getLine: function(e, t, i, n, a) {
                return e === i && (e = i = this.subPixelOptimize(e, a.width)),
                    t === n && (t = n = this.subPixelOptimize(t, a.width)), new r({
                        zlevel: this.getZlevelBase(),
                        hoverable: !1,
                        style: U.merge({
                                xStart: e,
            ...
            _buildBezierCurve: function(e, t, i, a) {
                ...
                if ("horizontal" === r) d = (m - l) * o + l, p = h, c = (m - l) * (1 - o) + l, u = V;
                    ...
                    if (e.id === this.tree.root.id)
                        d = (m - l) * o + l, p = (V - h) * o + h, c = (m - l) * (1 - o) + l, u = (V - h) * (1 - o) + h;
                    else {
                        ...
                        d = p * Math.cos(_) + k, p = p * Math.sin(_) + x, _ =
                            (c - this.minX) / this.width * Math.PI * 2, c = u * Math.cos(_) + k, u =
                            u * Math.sin(_) + x;
                    }
                var L = new s({
                    zlevel: this.getZlevelBase(),
            ...
            _setTreeShape: function(e) {
                ...
                n = "center" === n?.;;
                5 * o:;;
                this.parsePercent(n, o), a = "center" === a?.;;
                5 * r:;;
                this.parsePercent(a, r), a =
                    this.parsePercent(a, r), "horizontal" === i && (n = isNaN(n) ? 10 : n, a = isNaN(a)?.;;
                5 * r:;;
                a);;,
                "radial" === i ? (n = isNaN(n)?.;;
                5 * o:;;
                ...
                if ("radial" === i) {
                    ...
                    this.tree.traverse(function(e) {
                        m = Math.max(m, e.layout.position[0]), h = Math.min(h, e.layout.position[0]), V =
                            Math.max(V, e.layout.width);
                    }), this.width = m - h + 2 * V, this.minX = h;
                }
                this.tree.traverse(function(e) {
                        var t = e.layout.position[0] - s + n, o = e.layout.position[1] + a;
                        if ("horizontal" === i && (o = e.layout.position[0] - s + a, t = e.layout.position[1] + n),
                            "radial" === i) {
                            t = e.layout.position[0], o = e.layout.position[1], e.layout.originPosition = [t, o];
                            var r = o, l = (t - h) / this.width * Math.PI * 2;
                            t = r * Math.cos(l) + n, o = r * Math.sin(l) + a, e.layout.angle = l;
                        }
                        e.layout.position[0] = t, e.layout.position[1] = o;
                    },
                    this);
            },
            refresh: function(e) {
            ...
            _buildSeries: function(e, t) { this._buildShape(e, t) }
        }, U.inherits(t, i), e("../chart").define("tree", t), t;
    }), define("echarts/layout/Tree",
    ["require", "zrender/tool/vector"],
    function(e) {
        function t(e) {
            e = e || {}, this.nodePadding = e.nodePadding || 30, this.layerPadding =
                e.layerPadding || 100, this._layerOffsets = [], this._layers = [];
        }
        ...
        return t.prototype.run = function(e) {
            ...
            this._layerOffsets[e.depth] =
                e.layout.position[0] + e.layout.width + this.nodePadding, this._layers[e.depth].push(e);
    ...
    function(e) {
        ...
        function i(e) { this.root = new t(e) }
        ...
        return t.prototype.add = function(e) {
        ...
        }, i.prototype.traverse = function(e, t) { this.root.traverse(e, t) }, i.prototype.getSubTree = function(e) {
            var t = this.getNodeById(e);
            if (t) {
                var n = new i(t.id);
                return n.root = t, n;
            }
        }, i.prototype.getNodeById = function(e) { return this.root.getNodeById(e) }, i.fromOptionData =
            function(e, n) {
                function a(e, i) {
            ...
            for (var a = {}, o = {}, r = 0; r < e.nodes.length; r++) {
                var s, l = e.nodes[r];
                0 === l.inDegree() ? (a[l.id] = new i(l.id), s = a[l.id].root) : s = new t(l.id), s.data =
                    l.data, o[l.id] = s;
            }
            var h = [];
