(function(mod) {
    ...
    function drawConnectors(dv) {
        ...
        iterateChunks(dv.diff,
            function(topOrig, botOrig, topEdit, botEdit) {
                if (topEdit > vpEdit.to ||
                    botEdit < vpEdit.from ||
                    topOrig > vpOrig.to ||
                    botOrig < vpOrig.from)
                    return;
    ...
    var MergeView = CodeMirror.MergeView = function(node, options) {
        ...
        var wrapElt = this.wrap =
            node.appendChild(elt("div", wrap, "CodeMirror-merge CodeMirror-merge-" + panes + "pane"));
    ...
    function chunkBoundariesAround(diff, n, nInEdit) {
        ...
        iterateChunks(diff,
            function(fromOrig, toOrig, fromEdit, toEdit) {
