define("ace/snippets",
    ...
    [
        "require", "exports", "module", "ace/keyboard/hash_handler", "ace/editor", "ace/snippets", "ace/range",
        "resources", "resources", "range", "tabStops", "resources", "utils", "actions", "ace/config", "ace/config"
    ],
    function(e, t, n) {
        "use strict";
        ...
        f.prototype = {
            setupContext: function(e) {
                this.ace = e, this.indentation =
                    e.session.getTabString(), u || (u = window.emmet), u.require("resources")
                    .setVariable("indentation", this.indentation), this.$syntax = null, this.$syntax = this.getSyntax();
            },
            ...
            getSyntax: function() {
                ...
                if (e == "html" || e == "php") {
                    ...
                    typeof n != "string" && (n = n[0]), n &&
                        (n = n.split("-"), n.length > 1 ? e = n[0] : e == "php" && (e = "html"));
                }
                return e;
            },
            getProfileName: function() {
                ...
                case"html":
                    ...
                    return e ||
                    (e = this.ace.session.getLines(0, 2).join("").search(/<!DOCTYPE[^>]+XHTML/i) != -1
                        ? "xhtml"
                        : "html"), e;
                }
                return"xhtml";
            ...
            $updateTabstops: function(e) {
                var t = 1e3,
                    ...
                    r = null,
                    i = u.require("range"),
                    s = u.require("tabStops"),
                    o = u.require("resources").getVocabulary("user"),
                    a = {
                        tabstop: function(e) {
                ...
                return e = s.processText(e, a), o.variables.insert_final_tabstop && !/\$\{0\}$/.test(e)
                    ? e += "${0}"
                    : r && (e = u.require("utils").replaceSubstring(e, "${0}", r)), e;
            }
        };
        var l = {
        ...
        t.updateCommands =
            ...
            }, t.isSupportedMode = function(e) { return e && /css|less|scss|sass|stylus|html|php|twig|ejs/.test(e) };
        var p = function(n, r) {
            var i = r;
            if (!i) return;
            var s = t.isSupportedMode(i.session.$modeId);
            n.enableEmmet === !1 && (s = !1), s &&
                typeof a == "string" &&
                e("ace/config").loadModule(a, function() { a = null }), t.updateCommands(i, s);
        };
        t.AceEmmetEditor =
            f, e("ace/config").defineOptions(i.prototype,
            "editor",
            {
                enableEmmet: {
                    set: function(e) {
            ...
            }), t.setCore = function(e) { typeof e == "string" ? a = e : u = e };
    });
(function() {
