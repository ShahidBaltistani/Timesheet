define("ace/mode/praat_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                var e =
                        "if|then|else|elsif|elif|endif|fi|endfor|endproc|while|endwhile|repeat|until|select|plus|minus|assert",
                    t =
                ...
                this.$rules = {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            regex:
                                /(^\s*)(?:([a-z][a-zA-Z0-9_]*\$?\s+)(=)(\s+))?(?:((?:no)?warn|nocheck|noprogress)(\s+))?((?:[A-Z][^.:"]+)(?:$|(?:\.{3}|:)))/
                        },
                        {
                        ...
                        { token: "keyword", regex: "(\\b(?:" + e + ")\\b)" }, { token: "string", regex: /"[^"]*"/ },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/praat_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            f = function() { this.HighlightRules = s, this.$outdent = new o };
        r.inherits(f, i), function() {
            this.lineCommentStart = "#", this.getNextLineIndent = function(e, t, n) {
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/praat";
