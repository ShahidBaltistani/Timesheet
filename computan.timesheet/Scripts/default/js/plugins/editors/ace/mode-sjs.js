define("ace/mode/doc_comment_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                var e = new i({ noES6: !0 }),
                    ...
                    n = function(e) { return e.isContextAware = !0, e },
                    r = function(e) {
                        return{
                            token: e.token,
                            regex: e.regex,
                            next: n(function(t, n) { return n.length === 0 && n.unshift(t), n.unshift(e.next), e.next })
                        };
                    },
                    s = function(e) {
                        return{
                            token: e.token,
                            regex: e.regex,
                            next: n(function(e, t) { return t.shift(), t[0] || "start" })
                        };
                    };
                this.$rules = e.$rules, this.$rules.no_regex =
                    [
                        ...
                        [{ token: "paren.rparen", regex: "\\|", next: "no_regex" }].concat(this.$rules
                            .function_arguments),
                    this.$rules.bstring =
                    [
                ...
                [
                    ...
                    r({ token: "paren.lparen", regex: "\\(", next: "bstring_interp_single_call" }),
                    s({ token: "paren.rparen", regex: "\\)" })
                ].concat(o);
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/sjs_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(f, i), function() {
            this.createWorker = function(e) { return null }, this.$id = "ace/mode/sjs";
