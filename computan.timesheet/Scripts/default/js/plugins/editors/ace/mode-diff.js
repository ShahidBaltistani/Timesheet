define("ace/mode/diff_highlight_rules",
                ...
                this.$rules = {
                    start: [
                        ...
                        },
                        {
                            regex: "^(\\d+)([,\\d]+)(a|d|c)(\\d+)([,\\d]+)(.*)$",
                            token: [
                                "constant.numeric", "punctuation.definition.range.diff", "constant.function",
                                "constant.numeric", "punctuation.definition.range.diff", "invalid"
                            ],
                            name: "meta."
                        ...
                        { regex: "\\s*$", token: "invalid" }, { defaultToken: "invisible", caseInsensitive: !0 }
                    ]
                };
            };
    ...
    function(e, t, n) {
        ...
        var r = e("../../lib/oop"),
            ...
            o = t.FoldMode = function(e, t) {
                this.regExpList = e, this.flag = t, this.foldingStartMarker =
                    RegExp("^(" + e.join("|") + ")", this.flag);
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/diff_highlight_rules",
