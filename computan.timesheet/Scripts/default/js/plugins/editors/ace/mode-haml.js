define("ace/mode/ruby_highlight_rules",
            ...
            c = function() {
                ...
                this.$rules = {
                    start: [
                        ...
                        { token: "comment", regex: "^=begin(?:$|\\s.*$)", next: "comment" },
                        {
                            ...
                            },
                            {
                                ...
                                push: [
                                    ...
                                    { token: "string.end", regex: /"/, next: "pop" }, { defaultToken: "string" }
                                ]
                            },
                            {
                                token: "string.start",
                        ...
                        ], { token: "text", regex: "::" }, { token: "variable.instance", regex: "@{1,2}[a-zA-Z_\\d]+" },
                        ...
                        { token: "punctuation.separator.key-value", regex: "=>" }, {
                            ...
                            onMatch: function(e, t, n) {
                                ...
                                return n.push(r, i[3]), [
                                    { type: "constant", value: i[1] }, { type: "string", value: i[2] },
    ...
    ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/ruby_highlight_rules"],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            i = e("./text_highlight_rules").TextHighlightRules,
            ...
            u = function() {
                this.$rules = {
                    ...
                    [
                        ...
                        { token: "keyword.other.doctype", regex: "^!!!\\s*(?:[a-zA-Z0-9-_]+)?" }, s.qString, s.qqString,
                        s.tString, { token: ["entity.name.tag.haml"], regex: /^\s*%[\w:]+/, next: "tag_single" },
                        { token: ["meta.escape.haml"], regex: "^\\s*\\\\." }, s.constantNumericHex,
                        s.constantNumericFloat, s.constantOtherSymbol,
                    ...
                    [
                        ...
                        { token: "punctuation.section", regex: "\\{", next: "section" }, s.constantOtherSymbol,
                        { token: "text", regex: /\s/, next: "start" },
                        { token: "empty", regex: "$|(?!\\.|#|\\{|\\[|=|-|~|\\/)", next: "start" }
                    ],
                    section: [
                        s.constantOtherSymbol, s.qString, s.qqString, s.tString, s.constantNumericHex,
                        s.constantNumericFloat, { token: "punctuation.section", regex: "\\}", next: "start" }
                    ],
                    embedded_ruby: [
                        s.constantNumericHex, s.constantNumericFloat,
                        { token: "support.class", regex: "[A-Z][a-zA-Z_\\d]+" },
                        { token: (new o).getKeywords(), regex: "[a-zA-Z_$][a-zA-Z0-9_$]*\\b" },
                        { token: ["keyword", "text", "text"], regex: "(?:do|\\{)(?: \\|[^|]+\\|)?$", next: "start" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/haml_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i),
            function() { this.lineCommentStart = ["//", "#"], this.$id = "ace/mode/haml" }.call(u.prototype), t.Mode =
                u;
    })