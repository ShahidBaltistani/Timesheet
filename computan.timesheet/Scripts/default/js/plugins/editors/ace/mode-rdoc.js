define("ace/mode/latex_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            u = function() {
                this.$rules = {
                    start:
                    [
                        { token: "comment", regex: "%.*$" }, { token: "text", regex: "\\\\[$&%#\\{\\}]" },
                        {
                            token: "keyword",
                            regex:
                    ...
                    nospell: [
                        ...
                        { token: "nospell.text", regex: "\\s+" }, { token: "nospell.text", regex: "\\w+" }
                    ]
                };
            };
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            i = e("./text").Mode,
            s = e("./text_highlight_rules").TextHighlightRules,
            o = e("./rdoc_highlight_rules").RDocHighlightRules,
            u = e("./matching_brace_outdent").MatchingBraceOutdent,
            a = function(e) { this.HighlightRules = o, this.$outdent = new u };
        r.inherits(a, i), function() {
            this.getNextLineIndent = function(e, t, n) { return this.$getIndent(t) }, this.$id = "ace/mode/rdoc";
