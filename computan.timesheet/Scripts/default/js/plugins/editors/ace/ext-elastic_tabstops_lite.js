define("ace/ext/elastic_tabstops_lite",
    ...
    function(e, t, n) {
        ...
        var r = function(e) {
            this.$editor = e;
            var t = this, n = [], r = !1;
            this.onAfterExec = function() { r = !1, t.processRows(n), n = [] }, this.onExec =
                function() { r = !0 }, this.onChange = function(e) {
                var t = e.data.range;
                r &&
                (n.indexOf(t.start.row) == -1 && n.push(t.start.row), t.end.row != t.start.row &&
                    n.push(t.end.row));
            };
        };
        (function() {
            this.processRows = function(e) {
                ...
                var t = this.$selectionColumnsForRow(e),
                    ...
                    r = n.map(function(e) { return 0 }).slice(1),
                ...
                for (var o = 0, u = s.length; o < u; o++) {
                    ...
                    var c = this.$editor.session.getLine(e).substr(0, f),
                        ...
                        p = c.length - h.length;
                    l > 0 &&
                    (this.$editor.session.getDocument()
                        .insertInLine({ row: e, column: f + 1 }, Array(l + 1).join(" ") + "	"), this.$editor.session
                        .getDocument().removeInLine(e, f, f + 1), r += l), l < 0 &&
                        p >= -l &&
        ...
        e("../config").defineOptions(i.prototype,
            "editor",
            {
                useElasticTabstops: {
                    set: function(e) {
                        e
                            ...
                            (this.commands.removeListener("afterExec", this.elasticTabstops.onAfterExec),
                                this.commands.removeListener("exec", this.elasticTabstops.onExec), this.removeListener(
                                    "change",
                                    this.elasticTabstops.onChange));
                    }
                }
            });
    });
