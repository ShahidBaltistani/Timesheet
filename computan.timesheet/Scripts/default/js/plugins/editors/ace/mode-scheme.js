define("ace/mode/scheme_highlight_rules",
            ...
            s = function() {
                ...
                this.$rules = {
                    start: [
                        ...
                        {
                            token: [
                                "punctuation.definition.variable.scheme", "variable.other.global.scheme",
    ...
    ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/scheme_highlight_rules"],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            i = e("./text").Mode,
        ...
        r.inherits(o, i), function() { this.lineCommentStart = ";", this.$id = "ace/mode/scheme" }.call(o.prototype),
            t.Mode = o;
    })