define("ace/mode/doc_comment_highlight_rules",
            ...
            o = function() {
                ...
                this.$rules = {
                    start: [
                        ...
                        {
                            onMatch: function(e, t, n) { return n.unshift(this.next, e.substr(2)), "string" },
                            regex: 'q"(?:[\\[\\(\\{\\<]+)',
                        ...
                        { token: f, regex: "[a-zA-Z_][a-zA-Z0-9_]*\\b" }, { token: "keyword.operator", regex: a },
                    ...
                    "quote-string": [
                        o, { token: "string", regex: '"[cdw]?', next: "start" }, { defaultToken: "string" }
                    ],
                    "backtick-string":
                        [o, { token: "string", regex: "`[cdw]?", next: "start" }, { defaultToken: "string" }],
                    "operator-heredoc-string": [
                        {
                            onMatch: function(e, t, n) {
                                ...
                                var r = { ">": "<", "]": "[", ")": "(", "}": "{" };
                                return Object.keys(r).indexOf(e) != -1 && (e = r[e]), e != n[1]
                                    ? "string"
                                    : (n.shift(), n.shift(), "string");
                            },
                            regex: '(?:[\\]\\)}>]+)"',
                            next: "start"
                        }, { token: "string", regex: "[^\\]\\)}>]+" }
                    ...
                    [
                        {
                            onMatch: function(e, t, n) {
                                return e = e.substring(0, e.length - 1), e != n[1]
                                    ? "string"
                                    : (n.shift(), n.shift(), "string");
                            },
                    ...
                    "d-asm-instruction": [
                        ...
                        { token: "comment", regex: "//.*$" }, { token: "constant.numeric", regex: "[0-9.xA-F]+" },
                        { token: "punctuation.operator", regex: "\\," },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/d_highlight_rules",
