define("ace/ext/spellcheck",
    ...
    function(e, t, n) {
        ...
        t.contextMenuHandler = function(e) {
            ...
            var u = "", a = o + " " + u;
            n.value =
                a, n.setSelectionRange(o.length, o.length + 1), n.setSelectionRange(0, 0), n.setSelectionRange(0,
                o.length);
            var f = !1;
            r.addListener(n, "keydown", function l() { r.removeListener(n, "keydown", l), f = !0 }),
