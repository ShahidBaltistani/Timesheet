define("ace/mode/perl_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                var e =
                    ...
                    r = this.createKeywordMapper({ keyword: e, "constant.language": t, "support.function": n },
                        "identifier");
                this.$rules = {
                    start: [
                    ...
                    block_comment: [
                        { token: "comment.doc", regex: "^=cut\\b", next: "start" }, { defaultToken: "comment.doc" }
                    ]
                };
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/perl_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            f = function() {
                this.HighlightRules = s, this.$outdent = new o, this.foldingRules =
                    new a({ start: "^=(begin|item)\\b", end: "^=(cut)\\b" });
            };
        r.inherits(f, i), function() {
            this.lineCommentStart = "#", this.blockComment =
                [{ start: "=begin", end: "=cut" }, { start: "=item", end: "=cut" }], this.getNextLineIndent =
                function(e, t, n) {
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/perl";
