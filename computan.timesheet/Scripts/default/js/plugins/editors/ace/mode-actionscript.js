define("ace/mode/actionscript_highlight_rules",
    ...
    function(e, t, n) {
                    ...
                    start: [
                        ...
                        { token: "keyword.operator.symbolic.actionscript.2", regex: "[-!%&*+=/?:]" },
                        {
                            token: [
                                ...
                                "punctuation.definition.preprocessor.actionscript.2", "meta.preprocessor.actionscript.2"
                            ],
                            regex: "^([ \\t]*)(#)([a-zA-Z]+)"
                        },
                        {
                            token: [
                                "storage.type.function.actionscript.2", "meta.function.actionscript.2",
                        ...
                        {
                            token: [
                                "storage.type.class.actionscript.2", "meta.class.actionscript.2",
        ...
        s.metaData =
                { fileTypes: ["as"], keyEquivalent: "^~A", name: "ActionScript", scopeName: "source.actionscript.2" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/actionscript_highlight_rules",
