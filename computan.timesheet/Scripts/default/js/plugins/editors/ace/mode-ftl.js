define("ace/mode/css_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var u = function() {
            ...
            this.embedRules(o, "ftl-", n, ["start"]), this.addRules({
                "ftl-dcomment": [{ token: "comment", regex: ".*?-->", next: "pop" }, { token: "comment", regex: ".+" }]
            }), this.normalizeRules();
        };
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            o = function() { this.HighlightRules = s };
        r.inherits(o, i), function() { this.$id = "ace/mode/ftl" }.call(o.prototype), t.Mode = o;
    })