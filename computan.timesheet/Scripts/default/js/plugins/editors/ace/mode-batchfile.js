define("ace/mode/batchfile_highlight_rules",
    ...
    function(e, t, n) {
            ...
            s = function() {
                this.$rules = {
                    start: [
                        ...
                        { token: "comment.line.colons.dosbatch", regex: "::.*$" }, { include: "variable" },
                        {
        ...
        s.metaData =
            { name: "Batch File", scopeName: "source.dosbatch", fileTypes: ["bat"] }, r.inherits(s, i), t
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/batchfile_highlight_rules",
