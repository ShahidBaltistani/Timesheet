    ...
    function(e, t, n) {
        ...
        function c(e, t, n, r, i, s) {
            ...
            return s = s || l, e.setDisplaySettings = function(t) {
                t == null && (t = n.style.display == "none"), t
                    ? (n.style.display = "block", n.hideButton.focus(), e.on("focus",
                        function r() { e.removeListener("focus", r), n.style.display = "none" }))
                    : e.focus();
        ...
        function h(e, n, i) {
            function f(e, t, n, r) {
                if (!n) {
                    e.push("<input type='checkbox' title='",
                        t,
                        "' ",
                        r + "" == "true" ? "checked='true'" : "",
                        "'></input>");
            ...
            m.type = "button", m.value =
                    "Hide", r.addListener(m, "click", function() { i.setDisplaySettings(!1) }), e.appendChild(m),
                e.hideButton = m;
        }
        ...
        t.transformTextarea = function(e, n) {
            ...
            i.isOldIE ? m.backgroundColor = "#333" : m.backgroundColor = "rgba(0, 0, 0, 0.6)", a(v, m),
                u.appendChild(v), n = n || t.defaultOptions;
            var g = o.edit(p);
            s = g.getSession(), s.setValue(e.value || e.innerHTML), g.focus(), u.appendChild(d), c(g, p, v, o, n, l),
                h(v, d, g);
            var y = "";
            return r.addListener(d,
                ...
                function(e) {
                    ...
                    r.capture(d,
                        function(e) {
                            u.style.width = e.clientX - t.left + n + "px", u.style.height =
                                e.clientY - t.top + i + "px", g.resize();
                        },
                        function() {});
                }), g;
        }, t.defaultOptions = {
