define("ace/mode/apache_conf_highlight_rules",
    ...
    function(e, t, n) {
            ...
            s = function() {
                this.$rules = {
                    start: [
                        {
                            token: [
                                "punctuation.definition.comment.apacheconf", "comment.line.hash.ini",
                        ...
                        {
                            token: [
                                "punctuation.definition.tag.apacheconf", "entity.tag.apacheconf", "text",
                        ...
                        {
                            token: [
                                "punctuation.definition.tag.apacheconf", "entity.tag.apacheconf",
                        ...
                        {
                            token: [
                                "keyword.alias.apacheconf", "text", "string.regexp.apacheconf", "text",
                        ...
                        {
                            token: [
                                "keyword.alias.apacheconf", "text", "entity.status.apacheconf", "text",
                                "string.regexp.apacheconf", "text", "string.path.apacheconf", "text"
                            ],
                            regex:
                        ...
                        {
                            token: [
                                "keyword.php.apacheconf", "text", "entity.property.apacheconf", "text",
                                "string.value.apacheconf", "text"
                            ],
                        ...
                        },
                        {
                            token:
                            [
                                "punctuation.variable.apacheconf", "variable.env.apacheconf",
                                "variable.misc.apacheconf", "punctuation.variable.apacheconf"
                            ],
                            regex:
                        ...
                        {
                            token: [
                                "text", "punctuation.definition.flag.apacheconf", "string.flag.apacheconf",
                                "punctuation.definition.flag.apacheconf", "text"
                            ],
                            regex: "(\\s)(\\[)(.*?)(\\])(\\s)"
                        }
                    ]
        ...
        {
            fileTypes: [
                "conf", "CONF", "htaccess", "HTACCESS", "htgroups", "HTGROUPS", "htpasswd", "HTPASSWD", ".htaccess",
                ".HTACCESS", ".htgroups", ".HTGROUPS", ".htpasswd", ".HTPASSWD"
            ],
            name: "Apache Conf",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/apache_conf_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i),
            function() { this.lineCommentStart = "#", this.$id = "ace/mode/apache_conf" }.call(u.prototype), t.Mode = u;
    })