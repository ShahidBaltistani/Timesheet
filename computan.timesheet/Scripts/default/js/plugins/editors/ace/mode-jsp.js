define("ace/mode/css_highlight_rules",
            ...
            o = function() {
                ...
                this.$rules =
                {
                    start: [
                        ...
                        }, { token: "lparen", regex: "[[({]" }, { token: "rparen", regex: "[\\])}]" },
                        { token: "text", regex: "\\s+" }
                    ],
                    comment: [
                        { token: "comment", regex: ".*?\\*\\/", next: "start" }, { token: "comment", regex: ".+" }
                    ]
            ...
            o = function() {
                ...
                var e = "request|response|out|session|application|config|pageContext|page|Exception",
                    ...
                    r = [
                        ...
                        { token: "variable.language", regex: e }, { token: "keyword", regex: t }
                    ];
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/jsp_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(f, i), function() { this.$id = "ace/mode/jsp" }.call(f.prototype), t.Mode = f
    })