define("ace/mode/css_highlight_rules",
            ...
            d = function() {
                ...
                this.$rules = {
                    ...
                    [
                        ...
                        { token: "string", regex: "@.*?{", push: "media" }, { token: "keyword", regex: "#[a-z0-9-_]+" },
                    ...
                    [
                        { token: "comment", regex: "\\/\\*", push: "comment" },
                        { token: "paren.lparen", regex: "\\{", push: "ruleset" },
                        { token: "string", regex: "\\}", next: "pop" }, { token: "keyword", regex: "#[a-z0-9-_]+" },
                        { token: "variable", regex: "\\.[a-z0-9-_]+" }, { token: "string", regex: ":[a-z0-9-_]+" },
                        { token: "constant", regex: "[a-z0-9-_]+" }, { caseInsensitive: !0 }
                    ],
                    ...
                    ruleset: [
                        ...
                        { token: e, regex: "\\-?[a-zA-Z_][a-zA-Z0-9_\\-]*" }, { caseInsensitive: !0 }
                    ]
                }, this.normalizeRules();
            };
    ...
    function(e, t, n) {
        ...
        r.inherits(s, i), s.getTagRule =
            ...
            s.getStartRule =
                ...
                function(e) { return{ token: "comment.doc", regex: "\\*\\/", next: e } }, t.DocCommentHighlightRules =
                s;
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/css_highlight_rules",
        "ace/mode/javascript_highlight_rules", "ace/mode/xml_highlight_rules"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            ...
            f = function() {
                u.call(this), this.addRules({
                    ...
                    }), this.embedTagRules(s, "css-", "style"), this.embedTagRules(o, "js-", "script"),
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                ...
                for (var o in this.$rules)
                    this.$rules[o].unshift({ token: "variable", regex: "{%", push: "liquid-start" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/liquid_highlight_rules",
    ...
    function(e, t, n) {
        var r = e("../lib/oop"),
            ...
            u = e("../range").Range,
            a = function() { this.HighlightRules = s, this.$outdent = new o };
        r.inherits(a, i), function() {
            this.blockComment = { start: "<!--", end: "-->" }, this.getNextLineIndent = function(e, t, n) {
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/liquid";
