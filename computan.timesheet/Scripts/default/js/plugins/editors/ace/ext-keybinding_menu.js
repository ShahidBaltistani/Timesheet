define("ace/ext/menu_tools/overlay_page",
    ...
    [
        "require", "exports", "module", "ace/editor", "ace/ext/menu_tools/overlay_page",
        ...
        function i(t) {
            if (!document.getElementById("kbshortcutmenu")) {
                ...
                s.id = "kbshortcutmenu", s.innerHTML =
                    "<h1>Keyboard Shortcuts</h1>" + o + "</div>", n(t, s, "0", "0", "0", null);
            }
        }

        var r = e("ace/editor").Editor;
        n.exports.init = function(e) {
            r.prototype.showKeyboardShortcuts = function() { i(this) }, e.commands.addCommands([
                {
                    name: "showKeyboardShortcuts",
                    bindKey: { win: "Ctrl-Alt-h", mac: "Command-Alt-h" },
                    exec: function(e, t) { e.showKeyboardShortcuts() }
                }
            ]);
        };
    });
