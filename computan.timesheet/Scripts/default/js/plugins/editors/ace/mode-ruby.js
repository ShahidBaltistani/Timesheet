define("ace/mode/ruby_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ruby_highlight_rules",
        "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/coffee"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            ...
            this.lineCommentStart = "#", this.getNextLineIndent = function(e, t, n) {
                    ...
                    if (e == "start") {
                        var o = t.match(/^.*[\{\(\[]\s*$/),
                            ...
                            a = t.match(/.*do(\s*|\s+\|.*\|\s*)$/),
                            f = t.match(/^\s*(if|else)\s*/);
                        if (o || u || a || f) r += n;
                    }
                    return r;
                }, this.checkOutdent =
                    function(e, t, n) { return/^\s+(end|else)$/.test(t + n) || this.$outdent.checkOutdent(t, n) },
