            ...
            o = function() {
                this.$rules = {
                    start: [
                        ...
                        { token: "comment", regex: "<.+>" }, { token: "comment", regex: "\\| ", next: "table-item" },
                        { token: "comment", regex: "\\|$", next: "start" }
                    ],
                    qqstring3: [
                        { token: "constant.language.escape", regex: s },
                        { token: "string", regex: '"{3}', next: "start" }, { defaultToken: "string" }
                    ],
                    qqstring: [
                        { token: "constant.language.escape", regex: s },
                        { token: "string", regex: "\\\\$", next: "qqstring" },
                    ...
                    "table-item": [{ token: "string", regex: "[A-Za-z0-9 ]*", next: "start" }]
                };
            };
    ...
    function(e, t, n) {
        ...
        r.inherits(o, i), function() {
            this.lineCommentStart = "#", this.$id = "ace/mode/gherkin", this.getNextLineIndent = function(e, t, n) {
                ...
                return console.log(e), t.match("[ ]*\\|") && (r += "| "), o.length && o[o.length - 1].type == "comment"
                    ? r
                    : (e == "start" &&
