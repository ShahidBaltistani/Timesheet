define("ace/mode/cirru_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/cirru_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() { this.lineCommentStart = "--", this.$id = "ace/mode/cirru" }.call(u.prototype),
            t.Mode = u;
    })