define("ace/mode/elixir_highlight_rules",
            ...
            s = function() {
                this.$rules = {
                    ...
                    [
                        {
                            token: [
                                "meta.module.elixir", "keyword.control.module.elixir", "meta.module.elixir",
                        ...
                        },
                        {
                            ...
                            push: [
                                ...
                                { include: "#interpolated_elixir" }, { include: "#escaped_char" },
                        ...
                        },
                        {
                            ...
                            push: [
                                ...
                                { include: "#escaped_char" }, { defaultToken: "string.interpolated.elixir" }
                            ],
                            comment: "sigil (allow for interpolation)"
                        },
                        {
                    ...
                    "#escaped_char":
                        [{ token: "constant.character.escape.elixir", regex: "\\\\(?:x[\\da-fA-F]{1,2}|.)" }],
                    "#interpolated_elixir":
                    [
                        {
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/elixir_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() { this.lineCommentStart = "#", this.$id = "ace/mode/elixir" }.call(u.prototype),
            t.Mode = u;
    })