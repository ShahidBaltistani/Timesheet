define("ace/mode/mel_highlight_rules",
            ...
            s = function() {
                this.$rules = {
                    start: [
                        ...
                        {
                            token: [
                                "meta.function.mel", "keyword.other.mel", "storage.type.mel",
                                "entity.name.function.mel", "punctuation.section.function.mel"
                            ],
                            regex:
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mel_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            a = function() { this.HighlightRules = s, this.$behaviour = new o, this.foldingRules = new u };
