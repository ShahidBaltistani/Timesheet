define("ace/mode/asciidoc_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                ...
                this.$rules = {
                    ...
                    [
                        { include: "paragraphEnd" }, { token: "comment", regex: "^//.+$" },
                    ...
                    [
                        ...
                        { token: "link", regex: /\b[\w\.\/\-]+@[\w\.\/\-]+\b/ }, { include: "macros" },
                        { include: "paragraphEnd" }, { token: "literal", regex: /\+{3,}/, next: "smallPassthrough" },
                        {
                            token: "escape",
                    ...
                    [
                        ...
                        { token: "tableBlock", regex: /\|/ }, { include: "text", noEscape: !0 }
                    ],
                    innerTableBlock:
                    [
                    ...
                    quotes: [
                        { token: "string.italic", regex: /__[^_\s].*?__/ }, { token: "string.italic", regex: t("_") },
                        { token: "keyword.bold", regex: /\*\*[^*\s].*?\*\*/ },
                        { token: "keyword.bold", regex: t("\\*") },
                        { token: "literal", regex: t("\\+") }, { token: "literal", regex: /\+\+[^+\s].*?\+\+/ },
                        { token: "literal", regex: /\$\$.+?\$\$/ }, { token: "literal", regex: t("`") },
                        { token: "keyword", regex: t("^") }, { token: "keyword", regex: t("~") },
    ...
    function(e, t, n) {
        ...
        r.inherits(o, i), function() {
            this.foldingStartMarker = /^(?:\|={10,}|[\.\/=\-~^+]{4,}\s*$|={1,5} )/, this.singleLineHeadingRe =
                /^={1,5}(?=\s+\S)/, this.getFoldWidget = function(e, t, n) {
                var r = e.getLine(n);
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/asciidoc_highlight_rules",
