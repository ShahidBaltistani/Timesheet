define("ace/mode/doc_comment_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                var e =
                    ...
                    n = this.createKeywordMapper({ "keyword.declaration.protobuf": t, "support.type": e },
                        "identifier");
                this.$rules = {
                    start: [
                        { token: "comment", regex: /\/\/.*$/ }, { token: "comment", regex: /\/\*/, next: "comment" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp", "ace/mode/protobuf_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            u = function() { i.call(this), this.foldingRules = new o, this.HighlightRules = s };
        r.inherits(u, i), function() {
            this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/" }, this.$id =
                "ace/mode/protobuf";
