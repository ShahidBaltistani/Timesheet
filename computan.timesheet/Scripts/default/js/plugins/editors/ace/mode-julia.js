define("ace/mode/julia_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                this.$rules = {
                    start:
                    [
                        { include: "#function_decl" }, { include: "#function_call" }, { include: "#type_decl" },
                        { include: "#keyword" }, { include: "#operator" }, { include: "#number" },
                    ...
                    [
                        {
                            token: [
                                "keyword.other.julia", "meta.function.julia", "entity.name.function.julia",
                                "meta.function.julia", "text"
                            ],
                            regex:
                    ...
                    "#type_decl": [
                        {
                            token: [
                                "keyword.control.type.julia", "meta.type.julia", "entity.name.type.julia",
                                "entity.other.inherited-class.julia", "punctuation.separator.inheritance.julia",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/julia_highlight_rules",
