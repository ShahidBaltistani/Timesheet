define("ace/mode/ocaml_highlight_rules",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ocaml_highlight_rules",
    ...
    function(e, t, n) {
        ...
        (function() {
            this.toggleCommentLines = function(e, t, n, r) {
                ...
                var f = new u(0, 0, 0, 0);
                for (i = n; i <= r; i++)
                    s = t.getLine(i), f.start.row = i, f.end.row = i, f.end.column =
                        s.length, t.replace(f, o ? s.match(a)[1] : "(*" + s + "*)");
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/ocaml";
