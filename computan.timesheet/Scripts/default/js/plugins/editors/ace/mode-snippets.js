define("ace/mode/folding/coffee",
    ...
    function(e, t, n) {
            ...
            o = function() {
                ...
                this.$rules = {
                    ...
                    [
                        ...
                        {
                            onMatch: function(e, t, n) { return n[1] ? n[1]++ : n.unshift(t, 1), this.tokenName },
                    ...
                    varDecl: [
                        ...
                        { token: "keyword", regex: "(?:TM_)?(?:" + e + ")\\b" }, { token: "variable", regex: "\\w+" },
                        { regex: /:/, token: "punctuation.operator", next: "start" },
                        { regex: /\//, token: "string.regex", next: "regexp" }, { regex: "", next: "start" }
                    ],
                    regexp: [
                        { regex: /\\./, token: "escape" }, { regex: /\[/, token: "regex.start", next: "charClass" },
                        { regex: "/", token: "string.regex", next: "format" }, { token: "string.regex", regex: "." }
                    ],
                    charClass: [
                        { regex: "\\.", token: "escape" }, { regex: "\\]", token: "regex.end", next: "regexp" },
                        { token: "string.regex", regex: "." }
                    ],
                    format: [
                        { regex: /\\[ulULE]/, token: "keyword" }, { regex: /\$\d+/, token: "variable" },
                        { regex: "/[gim]*:?", token: "string.regex", next: "start" }, { token: "string", regex: "." }
                    ]
                };
            };
        ...
        var u = function() {
            ...
            {
                start: [
                    { token: "text", regex: "^\\t", next: "sn-start" }, { token: "invalid", regex: /^ \s*/ },
                    { token: "comment", regex: /^#.*/ },
                ...
                regex: [
                    { token: "text", regex: "\\." }, { token: "keyword", regex: "/" },
                ...
                [
                    ...
                    {
                        onMatch: function(e, t, n) { return n.splice(n.length), this.tokenName },
                        tokenName: "text",
                        regex: "^(?!	)",
                        next: "start"
                    }
        ...
        var a = e("./folding/coffee").FoldMode, f = function() { this.HighlightRules = u, this.foldingRules = new a };
