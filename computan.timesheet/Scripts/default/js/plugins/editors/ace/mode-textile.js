define("ace/mode/textile_highlight_rules",
            ...
            s = function() {
                this.$rules = {
                    ...
                    blocktagproperties: [
                        ...
                        { token: "string", regex: "[a-zA-Z0-9\\-_]+" }, { token: "keyword", regex: "#" }
                    ]
                };
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/textile_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() {
            this.type = "text", this.getNextLineIndent =
                function(e, t, n) { return e == "intag" ? n : "" }, this.checkOutdent =
                function(e, t, n) { return this.$outdent.checkOutdent(t, n) }, this.autoOutdent =
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/textile";
