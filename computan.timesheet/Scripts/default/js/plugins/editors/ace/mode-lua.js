define("ace/mode/lua_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                var e = "break|do|else|elseif|end|for|function|if|in|local|repeat|return|then|until|while|or|and|not",
                    ...
                    i = "",
                    s = "setn|foreach|foreachi|gcinfo|log10|maxn",
                    ...
                    start: [
                        {
                            ...
                            onMatch: function(e, t, n) { return n.unshift(this.next, e.length - 2, t), "comment" },
                            regex: /\-\-\[=*\[/,
                            next: [
                                {
                        ...
                        }, { token: "comment", regex: "\\-\\-.*$" },
                        {
                            ...
                            onMatch: function(e, t, n) { return n.unshift(this.next, e.length, t), "comment" },
                            regex: /\[=*\[/,
                            next: [
                                {
                                    onMatch: function(e, t, n) {
                        ...
                        { token: "string", regex: "'(?:[^\\\\]|\\\\.)*?'" }, { token: "constant.numeric", regex: p },
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() {
            this.foldingStartMarker = /\b(function|then|do|repeat)\b|{\s*$|(\[=*\[)/, this.foldingStopMarker =
                /\bend\b|^\s*}|\]=*\]/, this.getFoldWidget = function(e, t, n) {
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/lua_highlight_rules",
        "ace/mode/folding/lua", "ace/range", "ace/worker/worker_client"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            ...
            f = function() { this.HighlightRules = s, this.foldingRules = new o };
