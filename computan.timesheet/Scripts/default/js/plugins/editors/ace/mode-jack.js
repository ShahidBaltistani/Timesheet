define("ace/mode/jack_highlight_rules",
            ...
            s = function() {
                this.$rules = {
                    start: [
                        ...
                        { token: "paren.rparen", regex: "[\\])}]" }, { token: "storage.form", regex: "@[a-z]+" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/jack_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(f, i), function() {
            this.lineCommentStart = "--", this.getNextLineIndent = function(e, t, n) {
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/jack";
