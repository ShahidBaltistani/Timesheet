define("ace/mode/abap_highlight_rules",
            ...
            s = function() {
                ...
                this.$rules = {
                    start: [
                        ...
                        { token: "keyword", regex: t }, { token: "variable.parameter", regex: /\w+-\w+(?:-\w+)*/ },
                        { token: e, regex: "\\b\\w+\\b" }, { caseInsensitive: !0 }
                    ],
                    qstring: [
    ...
    [
        "require", "exports", "module", "ace/mode/abap_highlight_rules", "ace/mode/folding/coffee", "ace/range",
        "ace/mode/text", "ace/lib/oop"
    ],
    function(e, t, n) {
        "use strict";
        ...
        u.inherits(a, o), function() {
            this.getNextLineIndent = function(e, t, n) {
                ...
                for (var o = n; o <= r; ++o) {
                    var u = t.getLine(o);
                    if (herecommend.test(u)) continue;
                    commentLine.test(u) ? u = u.replace(commentLine, "$1") : u = u.replace(indentation, "$&#"),
                        i.end.row = i.start.row = o, i.end.column = u.length + 1, t.replace(i, u);
                }
