define("ace/mode/json_highlight_rules",
            ...
            s = function() {
                this.$rules = {
                    start: [
                        ...
                        { token: "invalid.illegal", regex: "\\/\\/.*$" }, { token: "paren.lparen", regex: "[[({]" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/json_highlight_rules",
        ...
        r.inherits(l, i), function() {
            this.getNextLineIndent = function(e, t, n) {
                ...
                return t.attachToDocument(e.getDocument()), t.on("error", function(t) { e.setAnnotations([t.data]) }),
                    t.on("ok", function() { e.clearAnnotations() }), t;
