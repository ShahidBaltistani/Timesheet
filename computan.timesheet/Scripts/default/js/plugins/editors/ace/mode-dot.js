define("ace/mode/matching_brace_outdent",
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/matching_brace_outdent",
        "ace/mode/dot_highlight_rules", "ace/mode/folding/cstyle"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            ...
            a = function() { this.HighlightRules = o, this.$outdent = new s, this.foldingRules = new u };
        r.inherits(a, i), function() {
            this.lineCommentStart = ["//", "#"], this.blockComment =
                { start: "/*", end: "*/" }, this.getNextLineIndent = function(e, t, n) {
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/dot";
