define("ace/mode/doc_comment_highlight_rules",
    ...
    function(e, t, n) {
        var r = e("../lib/oop"),
            ...
            u = function() {
                function i(e) {
                    ...
                    return{
                        ...
                        next: [
                            ...
                            { token: "string.end", next: "start", regex: t }, { defaultToken: "string" }
                        ]
                    };
                }
                ...
                {
                    start: [
                        { token: "comment", regex: "(?:-- |#).*$" }, i({ start: '"', escape: /\\[0'"bnrtZ\\%_]?/ }),
    ...
    ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mysql_highlight_rules", "ace/range"],
    function(e, t, n) {
        var r = e("../lib/oop"),
            i = e("../mode/text").Mode,
