define("ace/mode/ini_highlight_rules",
    ...
    function(e, t, n) {
            ...
            o = function() {
                this.$rules = {
                    start: [
                        ...
                        {
                            token: [
                                "punctuation.definition.entity.ini", "constant.section.group-title.ini",
        ...
        o.metaData =
                { fileTypes: ["ini", "conf"], keyEquivalent: "^~I", name: "Ini", scopeName: "source.ini" },
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ini_highlight_rules",
