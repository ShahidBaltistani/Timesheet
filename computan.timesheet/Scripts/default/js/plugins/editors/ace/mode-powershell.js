define("ace/mode/powershell_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                ...
                this.$rules = {
                    start: [
                        { token: "comment", regex: "#.*$" }, { token: "comment.start", regex: "<#", next: "comment" },
                        { token: "string", regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' },
                        { token: "string", regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" },
                    ...
                    comment: [
                        ...
                        { token: "doc.comment.tag", regex: "^\\.\\w+" }, { token: "comment", regex: "\\w+" },
                        { token: "comment", regex: "." }
                    ]
                };
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/powershell_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            f = function() {
                this.HighlightRules = s, this.$outdent = new o, this.$behaviour = new u, this.foldingRules =
                    new a({ start: "^\\s*(<#)", end: "^[#\\s]>\\s*$" });
            };
        r.inherits(f, i), function() {
            this.lineCommentStart = "#", this.blockComment = { start: "<#", end: "#>" }, this.getNextLineIndent =
                ...
                function(e) { return null }, this.$id = "ace/mode/powershell";
