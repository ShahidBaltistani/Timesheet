define("ace/occur",
    [
        "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search", "ace/edit_session",
        "ace/search_highlight", "ace/lib/dom"
    ],
    function(e, t, n) {
        "use strict";
        ...
        r.inherits(a, s), function() {
            this.enter = function(e, t) {
                ...
                var n = this.matchingLines(e.session, t),
                    r = n.map(function(e) { return e.content }),
                    i = new o(r.join("\n"));
                i.$occur = this, i.$occurMatchingLines = n, e.setSession(i), this.$useEmacsStyleLineStart =
                    this.$originalSession.$useEmacsStyleLineStart, i.$useEmacsStyleLineStart =
                    this.$useEmacsStyleLineStart, this.highlight(i, t.re), i._emit("changeBackMarker");
            }, this.displayOriginalContent =
                function(e) {
                    e.setSession(this.$originalSession), this.$originalSession.$useEmacsStyleLineStart =
    ...
    [
        "require", "exports", "module", "ace/config", "ace/lib/oop", "ace/keyboard/hash_handler",
        ...
        t.iSearchStartCommands = [
            {
                ...
                exec: function(e, t) {
                    r.loadModule(["core", "ace/incremental_search"],
                        function(n) {
            ...
            },
            {
                ...
                exec: function(e, t) { e.execCommand("iSearch", { backwards: !0 }) },
                readOnly: !0
            },
            {
                name: "iSearchAndGo",
                bindKey: { win: "Ctrl-K", mac: "Command-G" },
                exec: function(e, t) { e.execCommand("iSearch", { jumpToFirstMatch: !0, useCurrentOrPrevSearch: !0 }) },
                readOnly: !0
            },
            {
        ...
        ], t.iSearchCommands = [
            {
                name: "restartSearch",
                bindKey: { win: "Ctrl-F", mac: "Command-F" },
                exec: function(e) { e.cancelSearch(!0) },
                readOnly: !0,
            ...
            },
            {
                ...
                exec: function(e, t) { t.useCurrentOrPrevSearch = !0, e.next(t) },
                readOnly: !0,
                isIncrementalSearchCommand: !0
            },
            {
                ...
                exec: function(e, t) { t.useCurrentOrPrevSearch = !0, t.backwards = !0, e.next(t) },
                readOnly: !0,
                isIncrementalSearchCommand: !0
            },
            {
                name: "extendSearchTerm",
                exec: function(e, t) { e.addString(t) },
                readOnly: !0,
                isIncrementalSearchCommand: !0
            },
            {
            ...
            },
            {
                name: "cancelSearch",
                bindKey: "esc|Ctrl-G",
                exec: function(e) { e.deactivate(!0) },
                readOnly: !0,
                isIncrementalSearchCommand: !0
            }, {
                name: "occurisearch",
                ...
                exec: function(e) {
                    var t = e.$editor,
                        n = t.selection.getRangeOfMovements(function(e) { e.moveCursorWordRight() }),
                ...
                exec: function(e) {
                    var t = e.$editor,
                        n = t.selection.getRangeOfMovements(function(e) { e.moveCursorRight() }),
                        r = t.session.getTextRange(n);
                    e.addString(r);
                },
                readOnly: !0,
            ...
            },
            {
                ...
                bindKey: "Ctrl-l",
                exec: function(e) { e.$editor.execCommand("recenterTopBottom") },
                readOnly: !0,
                isIncrementalSearchCommand: !0
            }, {
                ...
                exec: function(e) {
                    var t = e.$editor,
                        ...
                        r = n && n.cache ? n.cache.reduce(function(e, t) { return e.concat(t ? t : []) }, []) : [];
            ...
            },
            {
                name: "searchAsRegExp",
                bindKey: "Alt-r",
                exec: function(e) { e.convertNeedleToRegExp() },
                readOnly: !0,
                isIncrementalSearchCommand: !0
            }
            ...
            this.attach = function(e) {
                var n = this.$iSearch;
                s.call(this, t.iSearchCommands, e.commands.platform), this.$commandExecHandler =
                    e.commands.addEventListener("exec",
                        function(e) {
                            return e.command.isIncrementalSearchCommand
                                ? (e.stopPropagation(), e.preventDefault(), e.command.exec(n, e.args || {}))
                                : undefined;
                        });
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search", "ace/search_highlight",
        "ace/commands/incremental_search_commands", "ace/lib/dom", "ace/commands/command_manager", "ace/editor",
        "ace/config"
    ],
    function(e, t, n) {
        "use strict";
        ...
        r.inherits(f, s), function() {
            this.activate = function(e, t) {
                    this.$editor = e, this.$startPos = this.$currentPos = e.getCursorPosition(), this.$options.needle =
                        "", this.$options.backwards =
                        t, e.keyBinding.addKeyboardHandler(this.$keyboardHandler), this.$originalEditorOnPaste =
                        e.onPaste, e.onPaste = this.onPaste.bind(this), this.$mousedownHandler =
                        e.addEventListener("mousedown", this.onMouseDown.bind(this)), this.selectionFix(e), this
                        .statusMessage(!0);
                }, this.deactivate = function(e) {
                    this.cancelSearch(e);
                    var t = this.$editor;
                    t.keyBinding.removeKeyboardHandler(this.$keyboardHandler), this.$mousedownHandler &&
                            (t.removeEventListener("mousedown", this.$mousedownHandler), delete this.$mousedownHandler),
                        t.onPaste = this.$originalEditorOnPaste, this.message("");
                }, this.selectionFix =
                    function(e) {
                    ...
                    return s &&
                    (n.backwards && (s = i.fromPoints(s.end, s.start)), this.$editor.selection.setRange(
                        i.fromPoints(o ? this.$startPos : s.end, s.end)), e && (this.$currentPos = s.end), this
                        .highlight(
                            n.re)), this.statusMessage(s), s;
                }, this.addString = function(e) {
                    return this.highlightAndFindWithNeedle(!1,
                        function(t) {
                            if (!l(t)) return t + e;
                            var n = c(t);
                    ...
                    function(e) {
                        return e = e || {}, this.$options.backwards = !!e.backwards, this.$currentPos =
                            this.$editor.getCursorPosition(), this.highlightAndFindWithNeedle(!0,
                            function(t) {
                                return e.useCurrentOrPrevSearch && t.length === 0 ? this.$prevNeedle || "" : t;
                            });
                    }, this.onMouseDown = function(e) { return this.deactivate(), !0 }, this.onPaste =
                    function(e) { this.addString(e) }, this.convertNeedleToRegExp =
                    function() {
                        return this.highlightAndFindWithNeedle(!1, function(e) { return l(e) ? e : h(e, "ig") });
                    },
                this.convertNeedleToString =
                    function() {
                        return this.highlightAndFindWithNeedle(!1, function(e) { return l(e) ? c(e).expression : e });
                    }, this.statusMessage = function(e) {
                    var t = this.$options, n = "";
                    n += t.backwards ? "reverse-" : "", n += "isearch: " + t.needle, n += e ? "" : " (not found)", this
                        .message(n);
        ...
        e("./config").defineOptions(m.prototype,
            "editor",
            {
    ...
    [
        "require", "exports", "module", "ace/lib/dom", "ace/incremental_search",
        "ace/commands/incremental_search_commands", "ace/keyboard/hash_handler", "ace/lib/keys"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/dom");
        ...
        t.handler.attach = function(e) {
            u ||
                (u = !0, r.importCssString(
                    ...
                    "emacsMode")), a = e.session.$selectLongWords, e.session.$selectLongWords = !0, f =
                    e.session.$useEmacsStyleLineStart, e.session.$useEmacsStyleLineStart = !0, e.session.$emacsMark =
                    null, e.session.$emacsMarkRing = e.session.$emacsMarkRing || [], e.emacsMark =
                    function() { return this.session.$emacsMark }, e.setEmacsMark =
                    function(e) { this.session.$emacsMark = e }, e.pushEmacsMark = function(e, t) {
                    var n = this.session.$emacsMark;
                    n && this.session.$emacsMarkRing.push(n), !e || t
                        ? this.setEmacsMark(e)
                    ...
                    function(e) { return this.session.$emacsMark || this.session.$emacsMarkRing.slice(-1)[0] },
                ...
                }, e.on("click", c), e.on("changeSession", l), e.renderer.screenToTextCoordinates =
                    s, e.setStyle("emacs-mode"), e.commands.addCommands(v), t.handler.platform =
                    e.commands.platform, e.$emacsModeHandler =
                    this, e.addEventListener("copy", this.onCopy), e.addEventListener("paste", this.onPaste);
        }, t.handler.detach = function(e) {
            delete e.renderer.screenToTextCoordinates, e.session.$selectLongWords =
                    a, e.session.$useEmacsStyleLineStart =
                    f, e.removeEventListener("click", c), e.removeEventListener("changeSession", l),
                e.unsetStyle("emacs-mode"), e.commands.removeCommands(v), e.removeEventListener("copy", this.onCopy),
                e.removeEventListener("paste", this.onPaste), e.$emacsModeHandler = null;
        };
        var l = function(e) {
                e.oldSession && (e.oldSession.$selectLongWords = a, e.oldSession.$useEmacsStyleLineStart = f), a =
                        e.session.$selectLongWords, e.session.$selectLongWords = !0, f =
                        e.session.$useEmacsStyleLineStart, e.session.$useEmacsStyleLineStart =
                        !0, e.session.hasOwnProperty("$emacsMark") || (e.session.$emacsMark = null),
                    e.session.hasOwnProperty("$emacsMarkRing") || (e.session.$emacsMarkRing = []);
            },
            c = function(e) { e.editor.session.$emacsMark = null },
            h = e("../lib/keys").KEY_MODS,
            p = { C: "ctrl", S: "shift", M: "alt", CMD: "command" },
            d = [
                "C-S-M-CMD", "S-M-CMD", "C-M-CMD", "C-S-CMD", "C-S-M", "M-CMD", "S-CMD", "S-M", "C-CMD", "C-M", "C-S",
                "CMD", "M", "S", "C"
            ];
        d.forEach(function(e) {
        ...
        }, t.handler.onPaste = function(e, t) { t.pushEmacsMark(t.getCursorPosition()) }, t.handler.bindKey =
            function(e, t) {
            ...
            if (o == "c-" || e.count) {
                ...
                if (typeof u == "number" && !isNaN(u))
                    return e.count = Math.max(e.count, 0) || 0, e.count = 10 * e.count + u, { command: "null" };
            }
            ...
            var f;
            typeof a != "string" &&
            (f = a.args, a.command && (a = a.command), a === "goorselect" &&
                (a = i.emacsMark() ? f[1] : f[0], f = null));
            if (typeof a == "string") {
                (a === "insertstring" || a === "splitline" || a === "togglecomment") && i.pushEmacsMark(), a =
                    this.commands[a] || i.commands.commands[a];
                if (!a) return undefined;
            }
            ...
            if (e.count) {
                ...
                if (!a || !a.handlesCount)
                    return{
                        args: f,
                        command: {
                            exec: function(e, t) { for (var n = 0; n < u; n++) a.exec(e, t) },
        ...
        }, t.emacsKeys =
        {
            ...
            recenterTopBottom: function(e) {
                ...
                Math.abs(n.top - i) < 2
                    ? i = n.top - r
                    : Math.abs(n.top - i - r * .5) < 2
                    ? i = n.top
                    : i = n.top - r * .5, e.session.setScrollTop(i);
            },
            ...
            setMark: {
                exec: function(e, t) {
                    ...
                    var n = e.emacsMark(),
                        ...
                        i = r.map(function(e) { return{ row: e.start.row, column: e.start.column } }),
                        s = !0,
                        o = r.every(function(e) { return e.isEmpty() });
                    if (s && (n || !o)) {
                        e.inMultiSelectMode
            ...
            killLine: function(e) {
                ...
                var n = e.getCursorPosition();
                n.column === 0 && e.session.doc.getLine(n.row).length === 0
                    ? e.selection.selectLine()
                    : (e.clearSelection(), e.selection.selectLineEnd());
                var r = e.getSelectionRange(), i = e.session.getTextRange(r);
                t.killRing.add(i), e.session.remove(r), e.clearSelection();
            },
            ...
            yankRotate: function(e) {
                ...
                e.undo(), e.session.$emacsMarkRing.pop(), e.onPaste(t.killRing.rotate()),
                    e.keyBinding.$data.lastCommand = "yank";
            },
            killRegion: {
                exec: function(e) { t.killRing.add(e.getCopyText()), e.commands.byName.cut.exec(e) },
                readOnly: !0,
                multiSelectAction: "forEach"
            },
            killRingSave: {
                exec: function(e) {
                    ...
                    t.killRing.add(e.getCopyText()), setTimeout(function() {
                            ...
                            e.$handlesEmacsOnCopy =
                                !1, e.inMultiSelectMode ? e.forEachSelection({ exec: t }) : t(), e.session
                                .$emacsMarkRing =
                                n.concat(r.reverse());
                        },
                        0);
        ...
        v.yank.isYank = !0, v.yankRotate.isYank = !0, t.killRing = {
            $data: [],
            add: function(e) { e && this.$data.push(e), this.$data.length > 30 && this.$data.shift() },
            get: function(e) {
                return e = e || 1, this.$data.slice(this.$data.length - e, this.$data.length).reverse().join("\n");
            },
            pop: function() { return this.$data.length > 1 && this.$data.pop(), this.get() },
            rotate: function() { return this.$data.unshift(this.$data.pop()), this.get() }
        };
    })