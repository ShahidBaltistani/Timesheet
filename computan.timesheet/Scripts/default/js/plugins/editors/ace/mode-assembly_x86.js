define("ace/mode/assembly_x86_highlight_rules",
    ...
    function(e, t, n) {
            ...
            s = function() {
                this.$rules = {
                    start: [
                        ...
                        {
                            token: [
                                "support.function.directive.assembly", "entity.name.function.assembly",
                                "support.function.directive.assembly", "constant.character.assembly"
                            ],
                        ...
                        }, { token: "support.function.directive.assembly", regex: "^%endmacro" },
                        {
                            token:
                            [
                                "text", "support.function.directive.assembly", "text", "entity.name.function.assembly"
                            ],
                            regex:
        ...
        s.metaData =
            { fileTypes: ["asm"], name: "Assembly x86", scopeName: "source.assembly" }, r.inherits(s, i), t
            .AssemblyX86HighlightRules = s;
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/assembly_x86_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i),
            function() { this.lineCommentStart = ";", this.$id = "ace/mode/assembly_x86" }.call(u.prototype), t.Mode =
                u;
    })