define("ace/mode/elm_highlight_rules",
            ...
            s = function() {
                ...
                this.$rules = {
                    ...
                    [
                        ...
                        }, { regex: "^" + n + i + "+", token: function(e) { return"constant.language" } },
                    ...
                    docComment: [
                        ...
                        { regex: "-}", token: "comment.end", next: "pop" }, { defaultToken: "doc.comment" }
                    ],
                    string: [
                    ...
                    stringGap: [
                        { token: "text", regex: /\\/, next: "string" }, { token: "error", regex: "", next: "start" }
                    ]
                }, this.normalizeRules();
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/elm_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() {
            this.lineCommentStart = "--", this.blockComment = { start: "{-", end: "-}" }, this.$id = "ace/mode/elm";
