define("ace/ext/chromevox",
    ...
    function(e, t, n) {
        ...
        var i = { rate: .8, pitch: .4, volume: .9 },
            s = { rate: 1, pitch: .5, volume: .9 },
            o = { rate: .8, pitch: .8, volume: .9 },
            u = { rate: .8, pitch: .3, volume: .9 },
            a = { rate: .8, pitch: .7, volume: .9 },
            f = { rate: .8, pitch: .8, volume: .9 },
            ...
            d = "insertMode",
            v = "start",
            m = [{ substr: ";", newSubstr: " semicolon " }, { substr: ":", newSubstr: " colon " }],
            g = {
                SPEAK_ANNOT: "annots",
        ...
        var b = null,
            ...
            N = {},
            C = {},
            k = function(e) { return y + String.fromCharCode(e) },
            L = function() {
            ...
            D = {
                ...
                meta: {
                    prop: s,
                    replace: [
                        { substr: "</", newSubstr: " closing tag " }, { substr: "/>", newSubstr: " close tag " },
            ...
            ct = function() {
                var e = dt.map(function(e) { return{ desc: e.desc + k(e.keyCode), cmd: e.cmd } }),
            ...
            dt =
            [
                { keyCode: 49, func: function() { tt(b.row) }, cmd: g.SPEAK_ANNOT, desc: "Speak annotations on line" },
            ...
            vt = function() {
                r.editor =
                        editor, editor.getSession().selection.on("changeCursor", J),
                    editor.getSession().selection.on("changeSelection", K), editor.getSession().on("change", Q),
                    editor.getSession().on("changeAnnotation", Z), editor.on("changeStatus", ft),
                    editor.on("findSearchBox", ht), editor.container.addEventListener("keydown", at), b =
                        editor.selection.getCursor();
            },
            mt = function(e) {
                vt(), dt.forEach(function(e) { N[e.keyCode] = e, C[e.cmd] = e }), e.on("focus", vt), L() &&
                    cvox.Api.setKeyEcho(!1), ct();
            },
            yt = 0,
            bt = 15,
            Et = e("../editor").Editor;
        e("../config").defineOptions(Et.prototype,
            "editor",
