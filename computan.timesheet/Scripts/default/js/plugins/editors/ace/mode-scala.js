define("ace/mode/doc_comment_highlight_rules",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                var e =
                        "case|default|do|else|for|if|match|while|throw|return|try|catch|finally|yield|abstract|class|def|extends|final|forSome|implicit|implicits|import|lazy|new|object|override|package|private|protected|sealed|super|this|trait|type|val|var|with",
                    t = "true|false",
                    n =
                ...
                this.$rules =
                {
                    ...
                    string: [
                        { token: "escape", regex: '\\\\"' }, { token: "string", regex: '"', next: "start" },
                        { token: "string.invalid", regex: '[^"\\\\]*$', next: "start" },
                        { token: "string", regex: '[^"\\\\]+' }
                    ],
                    tstring: [{ token: "string", regex: '"{3,5}', next: "start" }, { token: "string", regex: ".+?" }]
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            o = function() { i.call(this), this.HighlightRules = s };
        r.inherits(o, i), function() { this.createWorker = function(e) { return null }, this.$id = "ace/mode/scala" }
