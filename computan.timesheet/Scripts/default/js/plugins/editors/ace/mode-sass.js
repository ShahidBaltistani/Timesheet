define("ace/mode/scss_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                var e = i.arrayToMap(function() {
                    ...
                    t =
                        i.arrayToMap(
                            "hsl|hsla|rgb|rgba|url|attr|counter|counters|abs|adjust_color|adjust_hue|alpha|join|blue|ceil|change_color|comparable|complement|darken|desaturate|floor|grayscale|green|hue|if|invert|join|length|lighten|lightness|mix|nth|opacify|opacity|percentage|quote|red|round|saturate|saturation|scale_color|transparentize|type_of|unit|unitless|unqoute"
                            .split("|")),
                    n =
                        i.arrayToMap(
                    ...
                    s =
                        i.arrayToMap(
                            "@mixin|@extend|@include|@import|@media|@debug|@warn|@if|@for|@each|@while|@else|@font-face|@-webkit-keyframes|if|and|!default|module|def|end|declare"
                            .split("|")),
                    o = i.arrayToMap(
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                ...
                (e.splice(1,
                    1,
                    {
                        onMatch: function(e, t, n) { return n.unshift(this.next, -1, e.length - 2, t), "comment" },
                        regex: /^\s*\/\*/,
                        next: "comment"
                    },
                    { token: "error.invalid", regex: "/\\*|[{;}]" },
                    { token: "support.type", regex: /^\s*:[\w\-]+\s/ }), this.$rules.comment = [
                    {
                        regex: /^\s*/,
                        onMatch: function(e, t, n) {
                            return n[1] === -1 && (n[1] = Math.max(n[2], e.length - 1)), e.length <= n[1]
    ...
    function(e, t, n) {
        ...
        r.inherits(o, i), function() {
            this.getFoldWidgetRange = function(e, t, n) {
                ...
                return u != -1 && u < i ? e.foldWidgets[n - 1] = "start" : e.foldWidgets[n - 1] = "", i < a
                    ? "start"
                    : "";
            };
        }.call(o.prototype);
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sass_highlight_rules",
    ...
    function(e, t, n) {
        ...
        r.inherits(u, i), function() { this.lineCommentStart = "//", this.$id = "ace/mode/sass" }.call(u.prototype),
            t.Mode = u;
    })