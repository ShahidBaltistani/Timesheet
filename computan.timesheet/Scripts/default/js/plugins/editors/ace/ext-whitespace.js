    ...
    function(e, t, n) {
        ...
        t.$detectIndentation = function(e, t) {
            ...
            for (var u = 1; u < 12; u++) {
                ...
                9:;;
                .8, n.length || (v = 0));;:
                v /= d, r[u] && (v += r[u] / h), v > p.score && (p = { score: v, length: u });
            }
            ...
            for (var c = 0, h = a.length; c < h; c++) {
                ...
                if (d) {
                    ...
                    y += l[g] || (l[g] = r.stringRepeat(" ", g)), y != d &&
                        (u.removeInLine(c, 0, d.length), u.insertInLine({ row: c, column: 0 }, y));
                }
            }
            ...
            { name: "detectIndentation", exec: function(e) { t.detectIndentation(e.session) } },
            { name: "trimTrailingSpace", exec: function(e) { t.trimTrailingSpace(e.session) } }, {
