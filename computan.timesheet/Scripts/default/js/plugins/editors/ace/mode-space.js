define("ace/mode/folding/coffee",
        ...
        var r = e("../lib/oop"),
            ...
            s = function() {
                this.$rules = {
                    ...
                    key: [
                        { token: "variable", regex: /\S+/ }, { token: "empty_line", regex: /$/, next: "start" },
                        { token: "keyword.operator", regex: / /, next: "value" }
                    ],
                    value: [
                        { token: "keyword.operator", regex: /$/, next: "start" }, { token: "string", regex: /[^$]/ }
                    ]
                };
            };
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/folding/coffee",
    ...
    function(e, t, n) {
        ...
        var r = e("../lib/oop"),
            ...
            u = function() { this.HighlightRules = o, this.foldingRules = new s };
