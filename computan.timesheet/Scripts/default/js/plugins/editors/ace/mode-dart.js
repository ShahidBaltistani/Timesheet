define("ace/mode/doc_comment_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            u = function() {
                var e =
                    ...
                    t =
                        "asm|__asm__|auto|bool|_Bool|char|_Complex|double|enum|float|_Imaginary|int|long|short|signed|struct|typedef|union|unsigned|void|class|wchar_t|template",
                    n =
                        "const|extern|register|restrict|static|volatile|inline|private|protected|public|friend|explicit|virtual|export|mutable|typename|constexpr|new|delete",
                    r =
                ...
                this.$rules =
                {
                    start:
                    [
                        { token: "comment", regex: "//", next: "singleLineComment" }, i.getStartRule("doc-start"),
                    ...
                    [
                        ...
                        { token: "comment", regex: /$/, next: "start" }, { defaultToken: "comment" }
                    ],
                    qqstring:
                    [
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/c_cpp_highlight_rules",
        "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"
    ],
    function(e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
        ...
        r.inherits(l, i), function() {
            this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/" }, this.getNextLineIndent =
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/c_cpp";
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                var e = "true|false|null",
                    t = "this|super",
                    n =
                        "try|catch|finally|throw|rethrow|assert|break|case|continue|default|do|else|for|if|in|return|switch|while|new",
                    r = "abstract|class|extends|external|factory|implements|get|native|operator|set|typedef|with",
                ...
                this.$rules =
                {
                    ...
                    qstring: [{ token: "string", regex: "[^\\\\']*(?:\\\\.[^\\\\']*)*'", next: "start" }, a],
                    qqstring: [{ token: "string", regex: '[^\\\\"]*(?:\\\\.[^\\\\"]*)*"', next: "start" }, a]
                }, this.embedRules(i, "doc-", [i.getEndRule("start")]);
            };
        r.inherits(o, s), t.DartHighlightRules = o;
    }), define("ace/mode/dart",
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp", "ace/mode/dart_highlight_rules",
