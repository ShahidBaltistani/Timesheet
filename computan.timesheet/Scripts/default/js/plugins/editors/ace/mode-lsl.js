define("ace/mode/lsl_highlight_rules",
        ...
        function s() {
            ...
            this.$rules = {
                start: [
                    ...
                    { token: "paren.rparen.lsl", regex: "[\\]\\)\\}]" }, { token: "text.lsl", regex: "\\s+" }
                ],
                comment: [
    ...
    [
        "require", "exports", "module", "ace/mode/lsl_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range",
        "ace/mode/text", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/lib/oop"
    ],
    function(e, t, n) {
        "use strict";
        ...
        f.inherits(l, o), function() {
            this.lineCommentStart = ["//"], this.blockComment = { start: "/*", end: "*/" }, this.getNextLineIndent =
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/lsl";
