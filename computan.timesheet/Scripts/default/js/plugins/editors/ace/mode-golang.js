define("ace/mode/doc_comment_highlight_rules",
        ...
        var r = e("../lib/oop"),
            ...
            o = function() {
                var e =
                    ...
                    n = "make|close|new|panic|recover",
                ...
                this.$rules =
                {
                    ...
                    bqstring: [
                        { token: "string", regex: "(?:[^`]*)`", next: "start" }, { token: "string", regex: ".+" }
                    ]
    ...
    [
        "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/golang_highlight_rules",
    ...
    function(e, t, n) {
        var r = e("../lib/oop"),
            ...
            f = function() { this.HighlightRules = s, this.$outdent = new o, this.foldingRules = new a };
        r.inherits(f, i), function() {
            this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/" }, this.getNextLineIndent =
                ...
                function(e, t, n) { this.$outdent.autoOutdent(t, n) }, this.$id = "ace/mode/golang";
