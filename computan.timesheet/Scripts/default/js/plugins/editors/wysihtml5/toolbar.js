!function($, wysi) {
    ...
    var tpl = {
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
                ...
                size +
                "' data-wysihtml5-command='bold' title='" +
                locale.emphasis.bold +
                "' tabindex='-1'><i class='icon-bold2'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='italic' title='" +
                locale.emphasis.italic +
                "' tabindex='-1'><i class='icon-italic2'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='underline' title='" +
                locale.emphasis.underline +
                "' tabindex='-1'><i class='icon-underline2'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='strikeThrough' title='" +
                locale.emphasis.strike +
                "' tabindex='-1'><i class='icon-strikethrough3'></i></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
                ...
                "' tabindex='-1'><i class='icon-list-numbered'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='Outdent' title='" +
                locale.lists.outdent +
                "' tabindex='-1'><i class='icon-indent-decrease'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='Indent' title='" +
                locale.lists.indent +
                "' tabindex='-1'><i class='icon-indent-increase'></i></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<div class='checkbox'><label><input type='checkbox' class='bootstrap-wysihtml5-insert-link-target styled' checked>" +
                locale.link.target +
                "</label>" +
                "</div>" +
                "</div>" +
                ...
                locale.link.insert +
                "' tabindex='-1'><i class='icon-link'></i></a>" +
                "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                locale.image.insert +
                "' tabindex='-1'><i class='icon-image2'></i></a>" +
                "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
                ...
                locale.html.edit +
                "' tabindex='-1'><i class='icon-embed2'></i></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "alignment": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='justifyleft' title='" +
                locale.alignment.left +
                "' tabindex='-1'><i class='icon-paragraph-left3'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='justifyright' title='" +
                locale.alignment.right +
                "' tabindex='-1'><i class='icon-paragraph-right3'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='justifycenter' title='" +
                locale.alignment.center +
                "' tabindex='-1'><i class='icon-paragraph-center3'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='justifyfull' title='" +
                locale.alignment.full +
                "' tabindex='-1'><i class='icon-paragraph-justify3'></i></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "action": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='undo' title='" +
                locale.action.undo +
                "' tabindex='-1'><i class='icon-undo'></i></a>" +
                "<a class='btn btn-default btn-icon" +
                size +
                "' data-wysihtml5-command='redo' title='" +
                locale.action.redo +
                "' tabindex='-1'><i class='icon-redo'></i></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
                "<a class='btn btn-default dropdown-toggle" +
                size +
                "' data-toggle='dropdown' href='#' tabindex='-1'><i class='icon-droplet'></i>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            ...
            insertImageModal.on("shown.bs.modal",
                function() {
                    urlInput.focus();
                });
