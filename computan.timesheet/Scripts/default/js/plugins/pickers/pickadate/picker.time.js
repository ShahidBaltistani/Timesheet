 ...
 */
    TimePicker.prototype.set = function(type, value, options) {
        ...
        clockItem[(type == "enable" ? "disable" : type == "flip" ? "enable" : type)] = clock.queue[type].split(" ").map(
            function(method) {
 ...
 */
    TimePicker.prototype.now = function(type, value /*, options*/) {
        ...
        if (isValueInteger) {
            nowMinutes += interval *
            (
                isBelowInterval && type != "max" ? value + 1 : value
            );
        }
        ...
        return _.node(
            ...
            _.group({
                ...
                item: function(loopedTime) {
                    ...
                    return [
                        _.trigger(clock.formats.toString,
                            clock,
                            [_.trigger(settings.formatLabel, clock, [loopedTime]) || settings.format, loopedTime]),
                        (function(klasses) {
