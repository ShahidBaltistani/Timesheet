(function($) {
    ...
    var GmUtility = {
        ...
        setPosition: function(gMapContext, location, callback) {
            ...
            if (gMapContext.settings.enableReverseGeocode) {
                gMapContext.geodecoder.geocode({ latLng: gMapContext.location },
    ...
    function setupInputListenersInput(inputBinding, gmapContext) {
        if (inputBinding) {
            if (inputBinding.radiusInput) {
                inputBinding.radiusInput.on("change",
                    function() {
                        gmapContext.radius = $(this).val();
                        GmUtility.setPosition(gmapContext,
                            gmapContext.location,
                            function(context) {
                                context.settings.onchanged(GmUtility.locationFromLatLng(context.location),
                                    context.radius,
                                    false);
                            });
                    });
            ...
            if (inputBinding.locationNameInput && gmapContext.settings.enableAutocomplete) {
                ...
                google.maps.event.addListener(gmapContext.autocomplete,
                    "place_changed",
                    function() {
            ...
            if (inputBinding.latitudeInput) {
                inputBinding.latitudeInput.on("change",
                    function() {
                        GmUtility.setPosition(gmapContext,
                            new google.maps.LatLng($(this).val(), gmapContext.location.lng()),
                            function(context) {
                                context.settings.onchanged(GmUtility.locationFromLatLng(context.location),
                                    context.radius,
                                    false);
            ...
            if (inputBinding.longitudeInput) {
                inputBinding.longitudeInput.on("change",
                    function() {
                        GmUtility.setPosition(gmapContext,
                            new google.maps.LatLng(gmapContext.location.lat(), $(this).val()),
                            function(context) {
                                context.settings.onchanged(GmUtility.locationFromLatLng(context.location),
                                    context.radius,
                                    false);
    ...
    $.fn.locationpicker = function(options, params) {
        ...
        return this.each(function() {
            ...
            google.maps.event.addListener(gmapContext.marker,
                "dragend",
                function(event) {
                    GmUtility.setPosition(gmapContext,
