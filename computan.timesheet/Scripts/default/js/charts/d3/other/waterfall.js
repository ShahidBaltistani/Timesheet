...
$(function() {
    ...
    function waterfall(element, height) {
        ...
        d3.csv("assets/demo_data/d3/other/waterfall.csv",
            function(error, data) {
        ...
        function resize() {
            ...
            // Horizontal axis
            svg.selectAll(".d3-axis-horizontal").call(xAxis).selectAll("text").style("text-anchor", "end")
                .attr("dy", "-6px");
            ...
            // Bar group
            svg.selectAll(".d3-waterfall-bar")
                .attr("transform", function(d) { return "translate(" + x(d.name) + ",0)"; });
            ...
            // Connector line
            svg.selectAll(".d3-waterfall-connector").attr("x1", x.rangeBand() + 5)
                .attr("x2", x.rangeBand() / (1 - padding) - 5);
        }
    }
});