...
$(function() {
    ...
    function streamgraph(element, height) {
        ...
        d3.csv("assets/demo_data/dashboard/traffic_sources.csv",
            function(error, data) {
                            ...
                            .on("mousemove",
                                function(d, i) {
                                    ...
                                    tooltip.html(
                                            ...
                                            "<li>" +
                                            "<div class='text-size-base mt-5 mb-5'><i class='icon-circle-left2 position-left'></i>" +
                                            d.key +
                                            "</div>" +
                                            "</li>" +
                                            "<li>" +
                                            ...
                                            "Time: &nbsp; " +
                                            "<span class='text-semibold pull-right'>" +
                                            formatDate(d.values[mousedate].date) +
                                            "</span>" +
                                            "</li>" +
                                            "</ul>"
                                        )
                    ...
                    .on("mousemove",
                        function(d, i) {
                            ...
                            ($(element).outerWidth() -
                                ...
                                tooltip
                                    .style("left",
                                        (mousex - $(".d3-tip").outerWidth() - tooltipOffset) +
                                        "px") // Change tooltip direction from right to left to keep it inside graph area
                                    .attr("class", "d3-tip w");
                            } else {
                                tooltip
