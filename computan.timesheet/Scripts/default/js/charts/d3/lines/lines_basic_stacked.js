...
$(function() {
    ...
    function areaStacked(element, height) {
        ...
        d3.tsv("assets/demo_data/d3/lines/lines_stacked.tsv",
            function(error, data) {
        ...
        function resize() {
            ...
            // Text
            svg.selectAll(".d3-browsers").attr("transform",
                function(d) { return "translate(" + x(d.value.date) + "," + y(d.value.y0 + d.value.y / 2) + ")"; });
        }
    }
});