...
$(function() {
    ...
    function lineBasic(element, height) {
        ...
        d3.tsv("assets/demo_data/d3/lines/lines_multi_series.tsv",
            function(error, data) {
                ...
                city.append("text")
                    ...
                    .attr("transform",
                        function(d) { return "translate(" + x(d.value.date) + "," + y(d.value.temperature) + ")"; })
        ...
        function resize() {
            ...
            // Text
            svg.selectAll(".d3-cities").attr("transform",
                function(d) { return "translate(" + x(d.value.date) + "," + y(d.value.temperature) + ")"; });
        }
    }
});