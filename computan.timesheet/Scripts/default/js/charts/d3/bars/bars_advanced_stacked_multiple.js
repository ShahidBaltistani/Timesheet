...
$(function() {
    ...
    function stackedMultiples(element, height) {
        ...
        d3.tsv("assets/demo_data/d3/bars/bars_stacked_multiple.tsv",
            function(error, data) {
                ...
                function transitionMultiples() {
                    var t = svg.transition().duration(750),
                        g = t.selectAll(".d3-bar-group").attr("transform",
                            function(d) { return "translate(0," + y0(d.key) + ")"; });
                ...
                function transitionStacked() {
                    ...
                    g.select(".d3-group-label").attr("y",
                        function(d) { return y1(d.values[0].value / 2 + d.values[0].valueOffset); });
                }
            });
