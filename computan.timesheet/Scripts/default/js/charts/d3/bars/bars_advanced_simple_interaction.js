...
$(function() {
    ...
    function interaction(element, height) {
        ...
        // Demo data set
        var dataset = [
            40.5, 33.1, 31.6, 31.0, 29.9, 28.9, 25.2, 25.2, 24.8, 24.3, 24.0, 22.6, 20.5, 19.5, 19.0, 18.9, 18.8, 18.5,
            18.4, 17.6, 17.1
        ];
        ...
        $(".toggle-dataset").on("change",
            function() {
                if (this.checked) {

                    dataset = [
                        8.4, 12.1, 25.5, 10.3, 11.7, 10.9, 13.3, 23.1, 15.4, 12.3, 17.8, 18.8, 14.7, 8.8, 11.2, 10.2,
                        17.1, 14.5, 11.9, 7.3, 7.4
                    ];
                    ...
                    dataset = [
                        40.5, 33.1, 31.6, 31.0, 29.9, 28.9, 25.2, 25.2, 24.8, 24.3, 24.0, 22.6, 20.5, 19.5, 19.0, 18.9,
                        18.8, 18.5, 18.4, 17.6, 17.1
                    ];
