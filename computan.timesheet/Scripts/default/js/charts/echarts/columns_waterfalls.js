                        ...
                        itemStyle: {
                            normal: {
                                ...
                                label: {
                                    ...
                                    position: "top",
                                    formatter: function(params) {
                                        for (var i = 0, l = thermometer_columns_options.xAxis[0].data.length;
                                            i < l;
                                            i++) {
                ...
                options: [
                    {
                        ...
                        legend: {
                            data: [
                                "GDP", "Financial", "Real Estate", "Primary industry", "Secondary industry",
                                "Third industry"
                            ]
                        },
                        ...
                        xAxis: [
                            {
                                ...
                                data: [
                                    "Paris", "Budapest", "Prague", "Madrid", "Amsterdam", "Berlin", "Bratislava",
                                    "Munich", "Hague", "Rome", "Milan"
                                ]
                            }
                        ],
