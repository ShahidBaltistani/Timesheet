...
$(function() {
    ...
    $(".panel-heading, .page-header-content, .panel-body").has("> .heading-elements")
        .append('<a class="heading-elements-toggle"><i class="icon-menu"></i></a>');


    // Toggle visible state of heading elements
    $(".heading-elements-toggle").on("click",
        function() {
    ...
    $(".breadcrumb-elements-toggle").on("click",
        function() {
    ...
    // Disabled links
    $(".navbar-nav .disabled a").on("click",
        function(e) {
            e.preventDefault();
            e.stopPropagation();
        });
    ...
    $('.dropdown-content a[data-toggle="tab"]').on("click",
        function(e) {
            $(this).tab("show");
        });
    ...
    // Main navigation
    $(".navigation-main").find("li").has("ul").children("a").on("click",
        function(e) {
            e.preventDefault();

            // Collapsible
            $(this).parent("li").not(".disabled")
                .not($(".sidebar-xs").not(".sidebar-xs-indicator").find(".navigation-main").children("li"))
    ...
    $(".navigation-alt").find("li").has("ul").children("a").on("click",
        function(e) {
            e.preventDefault();
            ...
            if ($(".navigation-alt").hasClass("navigation-accordion")) {
                $(this).parent("li").not(".disabled").siblings(":has(.has-ul)").removeClass("active").children("ul")
                    .slideUp(200);
            }
        });
    ...
    // Toggle main sidebar
    $(".sidebar-mobile-main-toggle").on("click",
        function(e) {
            e.preventDefault();
    ...
    $(".sidebar-mobile-secondary-toggle").on("click",
        function(e) {
            e.preventDefault();
            $("body").toggleClass("sidebar-mobile-secondary")
                .removeClass("sidebar-mobile-main sidebar-mobile-opposite sidebar-mobile-detached");
        });


    // Toggle opposite sidebar
    $(".sidebar-mobile-opposite-toggle").on("click",
        function(e) {
            e.preventDefault();
            $("body").toggleClass("sidebar-mobile-opposite")
                .removeClass("sidebar-mobile-main sidebar-mobile-secondary sidebar-mobile-detached");
        });


    // Toggle detached sidebar
    $(".sidebar-mobile-detached-toggle").on("click",
        function(e) {
            e.preventDefault();
            $("body").toggleClass("sidebar-mobile-detached")
                .removeClass("sidebar-mobile-main sidebar-mobile-secondary sidebar-mobile-opposite");
        });
