...
(function(window, undefined) {
    ...
    Globalize.addCultureInfo("se-NO",
        "default",
        {
            name: "se-NO",
            ...
            calendars: {
                standard: {
                    ...
                    days: {
                        names: [
                            "sotnabeaivi", "vuossárga", "maŋŋebárga", "gaskavahkku", "duorastat", "bearjadat",
                            "lávvardat"
                        ],
                    ...
                    monthsGenitive: {
                        names: [
                            "ođđajagimánu", "guovvamánu", "njukčamánu", "cuoŋománu", "miessemánu", "geassemánu",
