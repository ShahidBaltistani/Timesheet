...
(function(window, undefined) {
    ...
    Globalize.addCultureInfo("quz-EC",
        "default",
        {
            name: "quz-EC",
            ...
            calendars: {
                standard: {
                    days: {
                        names: [
                            "intichaw", "killachaw", "atipachaw", "quyllurchaw", "Ch' askachaw", "Illapachaw",
                            "k'uychichaw"
                        ],
                    ...
                    months: {
                        names: [
                            ...
                            "Anta Sitwa", "Qhapaq Sitwa", "Uma raymi", "Kantaray", "Ayamarq'a", "Kapaq Raymi", ""
                        ],
                        namesAbbr: [
