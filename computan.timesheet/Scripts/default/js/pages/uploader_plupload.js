        ...
        init: {
            ...
            StateChanged: function(up) {
                log("[StateChanged]",
                    ...
                    ? "STARTED"
                    : "STOPPED"); // Called when the state of the queue is changed
            },
            ...
            OptionChanged: function(up, name, value, oldValue) {
                log("[OptionChanged]",
                    ...
                    value,
                    "Old Value: ",
                    oldValue); // Called when one of the configuration options is changed
            },

            BeforeUpload: function(up, file) {
                log("[BeforeUpload]",
                    "File: ",
                    file); // Called right before the upload for a given file starts, can be used to cancel it if required
            },
