...
$(function() {
    ...
    $(".tree-table").fancytree({
        ...
        renderColumns: function(event, data) {
            ...
            $tdList.eq(4).addClass("text-center")
                .html("<input type='checkbox' class='styled' name='like' value='" + node.key + "'>");
    ...
    $(".tree-table").delegate("input[name=like]",
        "click",
        function(e) {
