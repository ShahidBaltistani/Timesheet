...
$(function() {
    ...
    // Custom style
    $("#pnotify-custom-styled").on("click",
        function() {
            new PNotify({
                title: "Info notice",
                text: "Check me out! I'm a notice.",
    ...
    // Solid primary
    $("#pnotify-solid-primary").on("click",
        function() {
            new PNotify({
                title: "Primary notice",
                text: "Check me out! I'm a notice.",
    ...
    // Solid success
    $("#pnotify-solid-success").on("click",
        function() {
            new PNotify({
                title: "Success notice",
                text: "Check me out! I'm a notice.",
    ...
    // Solid warning
    $("#pnotify-solid-warning").on("click",
        function() {
            new PNotify({
                title: "Warning notice",
                text: "Check me out! I'm a notice.",
    ...
    // Solid styled left
    $("#pnotify-solid-styled-left").on("click",
        function() {
            new PNotify({
                title: "Info notice",
                text: "Check me out! I'm a notice.",
    ...
    // Solid styled right
    $("#pnotify-solid-styled-right").on("click",
        function() {
            new PNotify({
                title: "Info notice",
                text: "Check me out! I'm a notice.",
    ...
    $("#pnotify-desktop-default").on("click",
        function() {
            ...
            (new PNotify({
                ...
                if ($(".ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *")
                    .is(e.target)) return;
    ...
    $("#pnotify-rich").on("click",
        function() {
            new PNotify({
                ...
                text:
                    'Look at my beautiful <strong>strong</strong>, <a href="#" class="alert-link">linked</a>, <em>emphasized</em>, and <u>underlined</u> text with <i class="icon-make-group"></i> icon.',
    ...
    $("#pnotify-form").on("click",
        function() {
            ...
            // Remove if cancelled
            notice.get().find("button[name=cancel]").on("click",
                function() {
                    notice.remove();
                });
        ...
        function() {
            ...
            new PNotify({
                ...
                after_open: function(PNotify) {
                    alert("I'm called after the notice opens. I'm passed the PNotify object for the current notice: " +
                        PNotify);
                },
                before_close: function(PNotify, timer_hide) {
                    var source_note =
                        "Return false to cancel close. Use PNotify.queueRemove() to set the removal timer again.";
                    dont_alert(
                        "I'm called before the notice closes. I'm passed the PNotify object for the current notice: " +
                        PNotify);
                    dont_alert(
                        "I also have an argument called timer_hide, which is true if the notice was closed because the timer ran down. Value: " +
                        timer_hide);
                },
                after_close: function(PNotify, timer_hide) {
                    alert("I'm called after the notice closes. I'm passed the PNotify object for the current notice: " +
                        PNotify);
                    dont_alert(
                        "I also have an argument called timer_hide, which is true if the notice was closed because the timer ran down. Value: " +
                        timer_hide);
    ...
    // Top left
    $("#pnotify-stack-top-left").on("click",
        function() {
            show_stack_top_left("primary");
        });

    // Bottom left
    $("#pnotify-stack-bottom-left").on("click",
        function() {
            show_stack_bottom_left("primary");
        });

    // Bottom right
    $("#pnotify-stack-bottom-right").on("click",
        function() {
            show_stack_bottom_right("danger");
        });

    // Custom left
    $("#pnotify-stack-custom-left").on("click",
        function() {
            show_stack_custom_left("success");
        });

    // Custom right
    $("#pnotify-stack-custom-right").on("click",
        function() {
            show_stack_custom_right("success");
        });

    // Custom top
    $("#pnotify-stack-custom-top").on("click",
        function() {
            show_stack_custom_top("info");
        });

    // Custom bottom
    $("#pnotify-stack-custom-bottom").on("click",
        function() {
