...
$(function() {
    ...
    $("#h-fill-nonpercentage-basic-reset").click(function() {
        $("#h-fill-nonpercentage-basic .progress-bar").attr("data-transitiongoal", 0)
    ...
    $("#h-center-nonpercentage-basic-reset").click(function() {
        $("#h-center-nonpercentage-basic .progress-bar").attr("data-transitiongoal", 0)
            .progressbar({ display_text: "center", use_percentage: false });
    });
