...
$(function() {
    ...
    // Manual trigger
    $(".elastic-manual-trigger").on("click",
        function() {
            $(".elastic-manual")
                .val(
    ...
    // Destroy method
    $(".elastic-destroy-trigger").on("click",
        function() {
    ...
    $inputLabelAbsolute.passy(function(strength) {
        ...
        $outputLabelAbsolute.css("background-color", feedback[strength].color)
            .css("color", feedback[strength].textColor);
    });

    // Input group indicator
    $inputGroup.passy(function(strength) {
        $outputGroup.text(feedback[strength].text);
        $outputGroup.css("background-color", feedback[strength].color).css("border-color", feedback[strength].color)
            .css("color", feedback[strength].textColor);
    });
