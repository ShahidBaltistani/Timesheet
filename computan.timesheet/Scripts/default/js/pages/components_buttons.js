...
$(function() {
    ...
    // CSS3 animations
    $(".dropdown-animated, .btn-group-animated").on("show.bs.dropdown",
        function(e) {
            $(this).find(".dropdown-menu").addClass("animated bounceIn").one(
    ...
    // Open
    $(".dropdown-velocity, .btn-group-velocity").on("show.bs.dropdown",
        function(e) {
    ...
    // Close
    $(".dropdown-velocity, .btn-group-velocity").on("hide.bs.dropdown",
        function(e) {
    ...
    // Open
    $(".dropdown-fade, .btn-group-fade").on("show.bs.dropdown",
        function(e) {
            $(this).find(".dropdown-menu").fadeIn(250);
        });

    // Close
    $(".dropdown-fade, .btn-group-fade").on("hide.bs.dropdown",
        function(e) {
