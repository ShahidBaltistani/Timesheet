...
$(function() {
    ...
    var hot_html_cells_data = [
        {
            ...
            title:
                "<a href='http://themeforest.net/item/limitless-responsive-web-application-kit/13080328' target='_blank'>Limitless - Responsive Web Application Kit</a>",
            description:
                "Limitless is one of the best application templates ever built. Very flexible and clean admin template based on Bootstrap and Less. Available in 4 different layouts.",
            sales: "<strong>12930</strong>",
            comments:
                "<div class='text-orange mb-5'><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i></div> 35 ratings",
        },
        {
            cover: "https://thumb-tf.s3.envato.com/files/91482991/icon.png",
            title:
                "<a href='http://themeforest.net/item/londinium-responsive-bootstrap-3-admin-template/6978619' target='_blank'>Londinium - responsive bootstrap 3 admin template</a>",
            description:
                "Londinium – a new premium admin skin with lots of custom elements, plugins and very flexible content structure. Londinium is powered with Bootstrap framework.",
            sales: "<strong>8509</strong>",
            comments:
                "<div class='text-orange mb-5'><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i></div> 56 ratings",
        },
        {
            cover: "https://thumb-tf.s3.envato.com/files/84750409/icon.png",
            title:
                "<a href='http://themeforest.net/item/its-brain-responsive-bootstrap-3-admin-template/909197' target='_blank'>It's Brain - Responsive Bootstrap 3 Admin Template</a>",
            description:
                "It's Brain admin template is based on Bootstrap framework and includes a lot of different features. Comes with fixed and liquid layouts in both light and dark versions.",
            sales: "<strong>3902</strong>",
            comments:
                "<div class='text-orange mb-5'><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i><i class='icon-star-full2'></i></div> 453 ratings",
        }
    ];
    ...
    // Mousedown event
    Handsontable.Dom.addEvent(hot_html_header,
        "mousedown",
        function(event) {
    ...
    var hot_change_type = new Handsontable(hot_change_type,
        {
            ...
            afterGetColHeader: function(col, TH) {
                ...
                // Click event
                Handsontable.Dom.addEvent(menu,
                    "click",
                    function(event) {
    ...
    function addButtonMenuEvent(button, menu) {
        Handsontable.Dom.addEvent(button,
            "click",
            function(event) {
                ...
                removeMenu = function(event) {
                    if (event.target.nodeName == "LI" &&
                        event.target.parentNode.className.indexOf("changeTypeMenu") !== -1) {
                        if (menu.parentNode) {
