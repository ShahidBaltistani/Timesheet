...
$(function() {
    ...
    $(".noty-runner").click(function() {
        ...
        noty({
            ...
            buttons: (self.data("type") != "confirm")
                ? false
                : [
                    {
    ...
    // Solid left
    $("#jgrowl-solid-styled-left").on("click",
        function() {
    ...
    // Solid right
    $("#jgrowl-solid-styled-right").on("click",
        function() {
    ...
    // Solid custom
    $("#jgrowl-solid-custom-styled").on("click",
        function() {
