...
$(function() {
    ...
    $("#ac-custom").autocomplete({
        ...
        .autocomplete("instance")._renderItem = function(ul, item) {
            return $("<li>").append("<span class='text-semibold'>" +
                item.label +
                "</span>" +
                "<br>" +
    ...
    $("#ac-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("assets/demo_data/jquery_ui/autocomplete.php",
                request,
    ...
    // Initialize
    $("#select-images").imageselectmenu({ width: "100%" }).imageselectmenu("menuWidget")
        .addClass("ui-selectmenu-images");
    ...
    // Culture
    $("#spinner-currency-culture").on("selectmenuchange",
        function() {
    ...
    // Culture
    $("#spinner-decimal-culture").on("selectmenuchange",
        function() {
    ...
    // Culture
    $("#spinner-time-culture").on("selectmenuchange",
        function() {
