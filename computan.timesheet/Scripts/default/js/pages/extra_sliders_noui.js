...
$(function() {
    ...
    slider_handles.noUiSlider.on("update",
    ...
    slider_range.noUiSlider.on("update",
        function(values, handle) {
    ...
    slider_stepping.noUiSlider.on("update",
        function(values, handle) {
    ...
    slider_nonlinear.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_nonlinear_step.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_nonlinear_snap.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_behaviour.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_tap_behaviour.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_drag_behaviour.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_drag_fixed.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_snap_behaviour.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_combined.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_tooltip.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_margin.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_direction.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_skip.noUiSlider.on("update",
        function(values, handle) {
    ...
    // Show the values
    slider_connect_upper.noUiSlider.on("update",
        function(values, handle) {
