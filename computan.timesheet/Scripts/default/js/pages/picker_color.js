...
$(function() {
    ...
    $(".colorpicker-event-change").spectrum({
        change: function(c) {
            ...
            label.removeClass("hidden")
                .html("Change called: " + '<span class="text-semibold">' + c.toHexString() + "</span>");
        }
    });
    ...
    $(".colorpicker-event-move").spectrum({
        move: function(c) {
            ...
            label.removeClass("hidden")
                .html("Move called: " + '<span class="text-semibold">' + c.toHexString() + "</span>");
        }
    });
    ...
    $(".colorpicker-event-hide").spectrum({
        hide: function(c) {
            ...
            label.removeClass("hidden")
                .html("Hide called: " + '<span class="text-semibold">' + c.toHexString() + "</span>");
        }
    });
    ...
    $(".colorpicker-event-show").spectrum({
        show: function(c) {
            ...
            label.removeClass("hidden")
                .html("Show called: " + '<span class="text-semibold">' + c.toHexString() + "</span>");
        }
    });
    ...
    // Attach event
    $(".colorpicker-event-dragstart").on("dragstart.spectrum",
        function(e, c) {
            var label = $("#dragstart-result");
            label.removeClass("hidden")
                .html("Dragstart called: " + '<span class="text-semibold">' + c.toHexString() + "</span>");
        });
    ...
    // Attach event
    $(".colorpicker-event-dragstop").on("dragstop.spectrum",
        function(e, c) {
            var label = $("#dragstop-result");
            label.removeClass("hidden")
                .html("Dragstop called: " + '<span class="text-semibold">' + c.toHexString() + "</span>");
        });
