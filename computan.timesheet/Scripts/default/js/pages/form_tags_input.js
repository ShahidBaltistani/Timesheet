...
$(function() {
    ...
    // Add class on init
    $(".tokenfield-primary").on("tokenfield:initialize",
        function(e) {
    ...
    $(".tokenfield-primary").on("tokenfield:createdtoken",
        function(e) {
    ...
    // Add class on init
    $(".tokenfield-teal").on("tokenfield:initialize",
        function(e) {
    ...
    // Add class when token is created
    $(".tokenfield-teal").on("tokenfield:createdtoken",
        function(e) {
    ...
    // Add class on init
    $(".tokenfield-purple").on("tokenfield:initialize",
        function(e) {
    ...
    // Add class when token is created
    $(".tokenfield-purple").on("tokenfield:createdtoken",
        function(e) {
    ...
    // Add class on init
    $(".tokenfield-success").on("tokenfield:initialize",
        function(e) {
    ...
    // Add class when token is created
    $(".tokenfield-success").on("tokenfield:createdtoken",
        function(e) {
    ...
    // Add class on init
    $(".tokenfield-danger").on("tokenfield:initialize",
        function(e) {
    ...
    // Add class when token is created
    $(".tokenfield-danger").on("tokenfield:createdtoken",
        function(e) {
    ...
    // Add class on init
    $(".tokenfield-warning").on("tokenfield:initialize",
        function(e) {
    ...
    // Add class when token is created
    $(".tokenfield-warning").on("tokenfield:createdtoken",
        function(e) {
    ...
    // Display values
    $('.tags-input, [data-role="tagsinput"], .tagsinput-max-tags, .tagsinput-custom-tag-class').on("change",
        function(event) {
            ...
            $("pre.val > code", $container)
                .html(($.isArray(val) ? JSON.stringify(val) : "\"" + val.replace('"', '\\"') + "\""));
    ...
    // Define elements
    var tagsMethods =
        $(".tagsinput-add-tag, .tagsinput-remove-tag, .tagsinput-remove-tags, .tagsinput-destroy, .tagsinput-refresh");
    ...
    // "Remove all" method
    $(".remove-all-tags-button").on("click",
        function() {
    ...
    // "Destroy" method
    $(".destroy-tagsinput-button").on("click",
        function() {
