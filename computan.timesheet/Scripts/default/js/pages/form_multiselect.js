...
$(function() {
    ...
    // Destroy
    $(".multiselect-destroy-button").on("click",
        function() {
            $(".multiselect-method-destroy").multiselect("destroy");
        });

    // Create
    $(".multiselect-create-button").on("click",
        function() {
            $(".multiselect-method-destroy").multiselect({
    ...
    // Select option
    $(".multiselect-select-button").on("click",
        function() {
    ...
    // Deselect
    $(".multiselect-deselect-button").on("click",
        function() {
    ...
    // Refresh
    $(".multiselect-refresh-button").on("click",
        function() {
    ...
    // Rebuild menu
    $(".multiselect-rebuild-button").on("click",
        function() {
    ...
    // Select first option
    $(".multiselect-select-cheese-button").on("click",
        function() {
    ...
    $(".multiselect-select-onions-button").on("click",
        function() {
    ...
    $(".multiselect-deselect-cheese-button").on("click",
        function() {
    ...
    $(".multiselect-deselect-onions-button").on("click",
        function() {
    ...
    // Enable
    $(".multiselect-enable1-button").on("click",
        function() {
            $(".multiselect-method-disable").multiselect("enable");
        });

    // Disable
    $(".multiselect-disable1-button").on("click",
        function() {
    ...
    // Enable
    $(".multiselect-enable2-button").on("click",
        function() {
            $(".multiselect-method-enable").multiselect("enable");
        });

    // Disable
    $(".multiselect-disable2-button").on("click",
        function() {
    ...
    // Select options
    $(".multiselect-display-values-select").on("click",
        function() {
    ...
    // Deselect options
    $(".multiselect-display-values-deselect").on("click",
        function() {
    ...
    // Display values
    $(".multiselect-show-values").on("click",
        function() {
            $(".values-area").text("Selected: " + $(".multiselect-display-values").val().join(", "))
    ...
    $(".multiselect-order-options-button").on("click",
        function() {
            var selected = [];
    ...
    $("#multiselect-reset-form").on("reset",
        function() {
