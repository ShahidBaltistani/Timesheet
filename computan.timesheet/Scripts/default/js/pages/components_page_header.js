...
$(function() {
    ...
    $("#reportrange").daterangepicker(
        ...
        function(start, end) {
            ...
            $("#reportrange .daterange-custom-display").html(start.format("<i>D</i> <b><i>MMM</i> <i>YYYY</i></b>") +
                "<em>&#8211;</em>" +
                end.format("<i>D</i> <b><i>MMM</i> <i>YYYY</i></b>"));
        }
    );

    // Format date
    $("#reportrange .daterange-custom-display")
        .html(moment().subtract("days", 29).format("<i>D</i> <b><i>MMM</i> <i>YYYY</i></b>") +
            "<em>&#8211;</em>" +
            moment().format("<i>D</i> <b><i>MMM</i> <i>YYYY</i></b>"));
    ...
    // Format date
    $(".daterange-ranges span")
        .html(moment().format("MMM D, YYYY") + " - " + moment().subtract("days", 29).format("MMM D, YYYY"));
