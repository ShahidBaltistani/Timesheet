...
$(function() {
    ...
    $("[data-popup=tooltip-custom]").tooltip({
        template:
            '<div class="tooltip"><div class="bg-indigo"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div></div>'
    });
    ...
    $("[data-popup=popover-custom]").popover({
        template:
            '<div class="popover border-indigo"><div class="arrow"></div><h3 class="popover-title bg-indigo"></h3><div class="popover-content"></div></div>'
    });
    ...
    $("[data-popup=popover-solid]").popover({
        template:
            '<div class="popover bg-indigo"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
    });
