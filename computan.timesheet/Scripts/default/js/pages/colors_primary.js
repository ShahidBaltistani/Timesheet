...
$(function() {
    ...
    $(".growl-launch").on("click",
        function() {
            $.jGrowl("I am a well highlighted primary notice..",
                { theme: "bg-primary-400", header: "Well highlighted" });
        });
    ...
    $("[data-popup=tooltip-custom]").tooltip({
        template:
            '<div class="tooltip"><div class="bg-primary"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div></div>'
    });
    ...
    $("[data-popup=popover-custom]").popover({
        template:
            '<div class="popover border-primary"><div class="arrow"></div><h3 class="popover-title bg-primary"></h3><div class="popover-content"></div></div>'
    });
