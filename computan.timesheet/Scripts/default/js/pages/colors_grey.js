...
$(function() {
    ...
    $("[data-popup=tooltip-custom]").tooltip({
        template:
            '<div class="tooltip"><div class="bg-grey-600"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div></div>'
    });
    ...
    $("[data-popup=popover-custom]").popover({
        template:
            '<div class="popover border-grey-600"><div class="arrow"></div><h3 class="popover-title bg-grey-600"></h3><div class="popover-content"></div></div>'
    });
    ...
    $("[data-popup=popover-solid]").popover({
        template:
            '<div class="popover bg-grey-600"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
    });
