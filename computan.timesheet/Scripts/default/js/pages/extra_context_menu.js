...
$(function() {
    ...
    // onShow callback
    $(".context-show-menu").on("show.bs.context",
        function() {
            alert("onShow event fired");
        });

    // onShown callback
    $(".context-shown-menu").on("shown.bs.context",
        function() {
            alert("onShown event fired");
        });

    // onHide callback
    $(".context-hide-menu").on("hide.bs.context",
        function() {
            alert("onHide event fired");
        });

    // onHidden callback
    $(".context-hidden-menu").on("hidden.bs.context",
        function() {
