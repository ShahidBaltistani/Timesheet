...
$(function() {
    ...
    $(".bootstrap-select-solid").on("show.bs.dropdown",
        function() {
    ...
    $(".bootstrap-select-menu-color").on("show.bs.dropdown",
        function() {
