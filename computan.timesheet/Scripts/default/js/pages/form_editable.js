...
$(function() {
    ...
    $("#button-variation").on("shown",
        function(e, editable) {
            editable.input.$input.parents(".editable-input").parent().find(".editable-submit")
                .removeClass("btn-success").addClass("btn-danger");
            editable.input.$input.parents(".editable-input").parent().find(".editable-cancel").removeClass("btn-danger")
    ...
    $("#icon-variation").on("shown",
        function(e, editable) {
            editable.input.$input.parents(".editable-input").parent().find(".editable-submit").children()
                .removeClass("icon-check").addClass("icon-task");
            editable.input.$input.parents(".editable-input").parent().find(".editable-cancel").children()
                .removeClass("icon-x").addClass("icon-menu6");
        });
    ...
    $("#multiple-fields").editable({
        ...
        tpl:
            '<div class="editable-address form-group"><label>City: </label><input type="text" name="city" class="form-control"></div>' +
    ...
    $("#input-group-addon").on("shown",
        function(e, editable) {
            editable.input.$input.wrap('<div class="input-group"></div>');
            $('<span class="input-group-addon"><i class="icon-mention"></i></span>')
                .insertBefore(editable.input.$input);
        });


    // Buttons
    $("#input-group-button").editable();
    $("#input-group-button").on("shown",
        function(e, editable) {
            editable.input.$input.wrap('<div class="input-group"></div>');
            $('<div class="input-group-btn"><button type="button" class="btn btn-default">Button</button></div>')
                .insertBefore(editable.input.$input);
        });
    ...
    $("#input-group-dropdown").on("shown",
        function(e, editable) {
            editable.input.$input.wrap('<div class="input-group"></div>');
            $(
                    '<div class="input-group-btn"><button type="button" class="btn btn-default btn-icon" data-toggle="dropdown"><i class="icon-cog5"></i> <span class="caret"></span></button> <ul class="dropdown-menu"> <li><a href="#">Action</a></li> <li><a href="#">Another action</a></li> <li><a href="#">Something else here</a></li> </ul> </div>')
                .insertBefore(editable.input.$input);
        });
    ...
    $("#single-styled-checkbox").on("shown",
        function(e, editable) {
    ...
    // Initialize plugin  and insert in editable popup on show
    $("#checkbox-unordered-list").on("shown",
        function(e, editable) {
            editable.input.$input.uniform();
        });
    ...
    $("#input-touchspin-basic").on("shown",
        function(e, editable) {
    ...
    $("#input-touchspin-advanced").on("shown",
        function(e, editable) {
            editable.input.$input.TouchSpin({
