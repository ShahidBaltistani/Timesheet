...
$(function() {
    ...
    // Add event
    Handsontable.Dom.addEvent(hot_search_basic_input,
        "keyup",
        function(event) {
    ...
    // Add event
    Handsontable.Dom.addEvent(hot_search_class_input,
        "keyup",
        function(event) {
    ...
    // Add event
    Handsontable.Dom.addEvent(hot_search_query_input,
        "keyup",
        function(event) {
    ...
    // Add event
    Handsontable.Dom.addEvent(hot_search_callback_input,
        "keyup",
        function(event) {
            var queryResult;
