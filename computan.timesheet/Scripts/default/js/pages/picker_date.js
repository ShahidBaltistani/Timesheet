...
$(function() {
    ...
    $(".daterange-predefined").daterangepicker(
        ...
        function(start, end) {
            $(".daterange-predefined span")
                .html(start.format("MMMM D, YYYY") + " &nbsp; - &nbsp; " + end.format("MMMM D, YYYY"));
            $.jGrowl("Date range has been changed",
                { header: "Update", theme: "bg-primary", position: "center", life: 1500 });
        }
    );

    // Display date format
    $(".daterange-predefined span").html(moment().subtract("days", 29).format("MMMM D, YYYY") +
        " &nbsp; - &nbsp; " +
    ...
    // Display date format
    $(".daterange-ranges span").html(moment().subtract("days", 29).format("MMMM D, YYYY") +
        " &nbsp; - &nbsp; " +
        moment().format("MMMM D, YYYY"));
