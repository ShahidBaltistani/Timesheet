        ...
        $.ajax({
            ...
            if (data.error) {
                ...
                case 2: // Already in cart.
                    ...
                    $(".aa-cartbox-summary ul").prepend('<li id="' +
                        cid +
                        '"><a class="aa-cartbox-img" href="/product/' +
                        producturl +
                        '"><img src="' +
                        productimage +
                        '" alt="img"></a><div class="aa-cartbox-info"><h4><a href="/product/' +
                        producturl +
                        '">' +
                        productname +
                        '</a></h4> <h4><a href="/product/' +
                        producturl +
                        '">' +
                        productcode +
                        '</a></h4><h4><span class="colorbox" style="background-color:' +
                        color +
                        ';"></span><a class="colorname" href="/product/' +
                        producturl +
                        '">' +
                        colorname +
                        "</a></h4><h4><span>" +
                        ...
                        "$" +
                        price.toFixed(2) +
                        '</span></h4><a href="#" data-cartprice="' +
                        price +
                        '" data-cartquantity="' +
                        productqty +
                        '" data-cartid="' +
                        cid +
                        '" class="remove removebutton" id="btndeletemycart"><fa class="fa fa-close"></fa></a></div></li>');
                    break;
