    ...
    p.defineMode("javascript",
        function(oa, t) {
            ...
            function w(a, c) {
                ...
                if (R.test(e))
                    return a.eatWhile(R), e =
                        a.current(), (d = ba.propertyIsEnumerable(e) && ba[e]) && "." != c.lastType
                        ? q(d.type, d.style, e)
            ...
            function g() { for (var a = arguments.length - 1; 0 <= a; a--) f.cc.push(arguments[a]) }
            ...
            function x(a) {
                ...
                var b = f.state;
                b.context
                    ? (f.marked = "def", c(b.localVars) || (b.localVars = { name: a, next: b.localVars }))
            ...
            function l(a, c) {
                var b = function() {
                    ...
                    else for (var h = b.lexical; h && ")" == h.type && h.align; h = h.prev) e = h.indented;
            ...
            function m(a) {
                function c(e) { return e == a ? b() : ";" == a ? g() : b(c) }
            ...
            function n(a) { return fa(a, !1) }

            function u(a) { return fa(a, !0) }
            ...
            function X(a) { return a.match(/[;\}\)\],]/) ? g() : g(n) }

            function ia(a) { return a.match(/[;\}\)\],]/) ? g() : g(u) }

            function M(a, c) { return"," == a ? b(n) : W(a, c, !1) }
            ...
            function Ba(a) { if ("}" == a) return f.marked = "string-2", f.state.tokenize = Q, b(O) }
            ...
            function sa(a) { return":" == a ? b(k, r) : g(M, m(";"), k) }

            function Aa(a) { if ("variable" == a) return f.marked = "property", b() }
            ...
            function F(a, c) {
                function e(d) {
                    return"," == d
                        ? (d = f.state.lexical, "call" == d.info && (d.pos = (d.pos || 0) + 1), b(a, e))
                        : d == c
                        ? b()
                        : b(m(c));
                }

                return function(d) { return d == c ? b() : g(a, e) };
            }
            ...
            function U(a) { return"}" == a ? b() : g(r, U) }

            function ja(a) { if (ka && ":" == a) return b(Da) }

            function Da(a) { if ("variable" == a) return f.marked = "variable-3", b() }

            function T() { return g(A, ja, Y, Ea) }
            ...
            function Y(a, c) { if ("\x3d" == c) return b(u) }

            function Ea(a) { if ("," == a) return b(T) }

            function da(a, c) {
                if ("keyword b" ==
                    a &&
                    "else" == c) return b(l("form", "else"), r, k);
            }

            function ea(a) { if ("(" == a) return b(l(")"), Ga, m(")"), k) }

            function Ga(a) {
                return"var" == a ? b(T, m(";"), P) : ";" == a ? b(P) : "variable" == a ? b(Ha) : g(n, m(";"), P);
            }

            function Ha(a, c) { return"in" == c || "of" == c ? (f.marked = "keyword", b(n)) : b(M, P) }
            ...
            function V(a) { return"spread" == a ? b(V) : g(A, ja) }

            function ua(a, c) { if ("variable" == a) return x(c), b(ma) }
            ...
            function wa(a) { return"string" == a ? b() : g(aa, Z) }
            ...
            function Ja(a, c) { if ("as" == c) return f.marked = "keyword", b(aa) }

            function Z(a, c) { if ("from" == c) return f.marked = "keyword", b(n) }

            function ya(a) { return"]" == a ? b() : g(u, Ka) }

            function Ka(a) { return"for" == a ? g(N, m("]")) : "," == a ? b(F(ia, "]")) : g(F(u, "]")) }
            ...
            var C = oa.indentUnit,
                ...
                ba = function() {
                    function a(a) { return{ type: a, style: "keyword" } }
            ...
            return{
                ...
                token: function(a, b) {
                    a.sol() &&
                    (b.lexical.hasOwnProperty("align") || (b.lexical.align = !1), b.indented =
                        a.indentation(), S(a, b));
                ...
                indent: function(a, b) {
                    ...
                    return"vardef" == f
                        ...
                        ? d.indented + C
                        : "stat" == f
                        ? (e = d.indented, d = "operator" == a.lastType ||
                            "," == a.lastType ||
                            K.test(b.charAt(0)) ||
                            /[,.]/.test(b.charAt(0)), e + (d ? na || C : 0))
