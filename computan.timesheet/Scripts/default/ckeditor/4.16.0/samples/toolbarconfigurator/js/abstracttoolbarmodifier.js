        ...
        afterInit: function(a) {
            a.addMode("wysiwyg",
                function(b) {
                    ...
                    c = a.editable(c);
                    c.detach = CKEDITOR.tools.override(c.detach,
                        function(b) {
                            return function() {
            ...
            a.dataProcessor.toHtml = function(b) { return b };
...
(function() {
    ...
    a.prototype.setConfig = function(b) { this._onInit(void 0, b, !0) };
    ...
    a.prototype._toggleEditable = function() { this.isEditableVisible ? this._hideEditable() : this._showEditable() };
    a.prototype._refreshEditor = function() {
        ...
        this.waitForReady ||
        ("unloaded" == a || "loaded" == a
            ? (this.waitForReady = !0, this.editorInstance.once("instanceReady", function() { b() }, this))
            : b());
    };
    a.prototype._createEditor = function(b, c) {
        ...
        this.editorInstance.on("uiSpace", function(b) { "top" != b.data.space && b.stop() }, null, null, -999);
        this.editorInstance.once("loaded",
            function() {
    ...
    a.prototype.getActualConfig = function() { return JSON.parse(JSON.stringify(this.actualConfig)) };
    ...
    a.prototype._createToolbarBtn = function(b) {
        ...
        c.on("click", function() { b.clickCallback.call(this, c, b) }, this);
        return c;
    };
    a.prototype._fixGroups = function(b) {
        ...
        for (var c = b.length, a = 0; a < c; a += 1) {
            var d = b[a];
            "/" == d
                ? (d = b[a] = {}, d.type = "separator", d.name = "separator" + CKEDITOR.tools.getNextNumber())
                : (d.groups = d.groups || [], -1 == CKEDITOR.tools.indexOf(d.groups, d.name) &&
                (this.editorInstance.ui.addToolbarGroup(d.name,
                    d.groups[d.groups.length - 1],
                    d.name), d.groups.push(d.name)), this._fixSubgroups(d));
        }
    };
    ...
    a.stringifyJSONintoOneLine = function(b, a) {
        ...
        a.addSpaces &&
        (e = e.replace(/(\{|:|,|\[|\])/g, function(a) { return a + " " }), e = e.replace(/(\])/g,
            function(a) {
                return" " +
                    a;
            }));
        a.noQuotesOnKey && (e = e.replace(/"(\w*)":/g, function(a, b) { return b + ":" }));
