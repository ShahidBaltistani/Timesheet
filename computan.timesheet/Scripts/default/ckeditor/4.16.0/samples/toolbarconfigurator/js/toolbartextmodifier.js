(function() {
    ...
    e.prototype._createModifier = function(a) {
        ...
        this.codeContainer.on("endCompletion",
            function(a, b) {
                var d = c(a);
            ...
            function() {
                ...
                null !== a
                    ? (k.actualConfig.toolbar = a.toolbar ? a.toolbar : k.actualConfig.toolbar,
                        k._fillHintByUnusedElements(), k._refreshEditor(), k.mainContainer.removeClass("invalid"))
    ...
    e.prototype._fillHintByUnusedElements = function() {
        var a = this.getUnusedButtonsArray(this.actualConfig.toolbar, !0),
            ...
            d = g.map(a,
                function(a) {
                    var b = g.map(a.buttons,
                        function(a) {
                            return"\x3ccode\x3e" +
                                a +
                                "\x3c/code\x3e ";
                        }).join("");
                    return["\x3cdt\x3e\x3ccode\x3e", a.name, "\x3c/code\x3e\x3c/dt\x3e\x3cdd\x3e", b, "\x3c/dd\x3e"]
                        .join("");
                }).join(" "),
            f =
    ...
    e.prototype.getUnusedButtonsArray = function(a, d, f) {
        ...
        a = g.filter(a, function(a) { return-1 == CKEDITOR.tools.indexOf(c, a) });
        d && a.sort();
        return a;
    };
    e.prototype.groupButtonNamesByGroup =
        function(a) {
            ...
            for (c in f) {
                var b = f[c], b = g.filter(b, function(b) { return-1 !== CKEDITOR.tools.indexOf(a, b) });
    ...
    e.prototype._setupActualConfig = function(a) {
        ...
        (a.toolbarGroups || (a.toolbarGroups = this.fullToolbarEditor.getFullToolbarGroupsConfig(!0)),
            this._fixGroups(a), a.toolbar =
                this._mapToolbarGroupsToToolbar(a.toolbarGroups, this.actualConfig.removeButtons),
            this.actualConfig.toolbar = a.toolbar, this.actualConfig.removeButtons = "");
    };
