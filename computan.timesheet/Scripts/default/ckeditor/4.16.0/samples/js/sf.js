...
(function() {
    for (var d = SF.getByClass("toggler"), c = d.length; c--;)
        SF.attachListener(d[c],
            "click",
            function() {
                var b = SF.classList.contains(this, "icon-toggler-expanded") ||
                ...
                SF.classList.contains(this, "collapsed")
                    ? (SF.classList.add(a, "collapsed"), b &&
                    (SF.classList.remove(this, "icon-toggler-expanded"), SF.classList.add(this,
                        "icon-toggler-collapsed")))
                    : (SF.classList.remove(a,
                        "collapsed"), b &&
                    (SF.classList.remove(this, "icon-toggler-collapsed"), SF.classList.add(this,
...
(function(d, c) {
    ...
    function a() {
        ...
        return{
            watch: a.push.bind(a),
            trigger: function(b) {
                for (var c = !0, d = { preventDefault: function() { c = !1 } }, e = 0; e < a.length; e++) a[e](b, d);
                return c;
            }
        };
    }
    ...
    function n(a, b) {
        ...
        return e.div().clazz("pico-content").clazz(a("modalClass", "")).stylize({
                ...
                { backgroundColor: "white", padding: "20px", borderRadius: "5px" })).html(a("content"))
            .attr("role", "dialog").onClick(function(a) {
    ...
    function k(c) {
        ...
        function r(a) {
            if (!t) {
                ...
                d = e("closeButton", !0)
                    ? c.child().html(e("closeHtml", "\x26#xD7;")).clazz("pico-close").clazz(e("closeClass")).stylize(
                        e("closeStyles",
                            {
                                borderRadius: "2px",
                                cursor: "pointer",
