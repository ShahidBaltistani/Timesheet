...
CKEDITOR.lang["zh"] = {
    ...
    "colordialog": { "clear": "清除", "highlight": "高亮", "options": "色彩選項", "selected": "選取的色彩", "title": "選取色彩" },
    "templates":
    {
        "button": "範本",
    ...
    "fakeobjects":
        { "anchor": "錨點", "flash": "Flash 動畫", "hiddenfield": "隱藏欄位", "iframe": "IFrame", "unknown": "無法辨識的物件" },
    "flash":
    {
        "access": "腳本存取",
        "accessAlways": "永遠",
    ...
    {
        "button":
            { "title": "按鈕內容", "text": "顯示文字 (值)", "type": "類型", "typeBtn": "按鈕", "typeSbm": "送出", "typeRst": "重設" },
        "checkboxAndRadio":
            { "checkboxTitle": "核取方塊內容", "radioTitle": "選項按鈕內容", "value": "數值", "selected": "已選", "required": "必填" },
        "form": { "title": "表單內容", "menu": "表單內容", "action": "動作", "method": "方式", "encoding": "編碼" },
    ...
    "smiley": { "options": "表情符號選項", "title": "插入表情符號", "toolbar": "表情符號" },
    ...
    "pastetext": { "button": "貼成純文字", "pasteNotification": "請按下「%1」貼上。您的瀏覽器不支援工具列按鈕或是內容功能表選項。 ", "title": "貼成純文字" },
    "pastefromword":
    {
    ...
    "easyimage": {
        "commands": { "fullImage": "全尺寸圖片", "sideImage": "側邊圖片", "altText": "變更圖片替代文字", "upload": "上傳圖片" },
