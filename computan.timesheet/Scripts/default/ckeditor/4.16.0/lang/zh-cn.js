...
CKEDITOR.lang["zh-cn"] = {
    ...
    "about": { "copy": "版权所有 &copy; $1。<br />保留所有权利。", "dlgTitle": "关于 CKEditor 4", "moreInfo": "相关授权许可信息请访问我们的网站：" },
    "basicstyles":
    ...
    "colordialog": { "clear": "清除", "highlight": "高亮", "options": "颜色选项", "selected": "选择颜色", "title": "选择颜色" },
    "templates":
    {
        "button": "模板",
        "emptyListMsg": "(没有模板)",
    ...
    {
        "label": "格式刷",
        "notification": { "copied": "格式已复制", "applied": "格式已应用", "canceled": "格式已取消", "failed": "格式化失败，您不能还没复制就应用格式" }
    },
    "div":
    {
        "IdInputLabel": "ID",
    ...
    "forms":
    {
        ...
        "checkboxAndRadio":
            { "checkboxTitle": "复选框属性", "radioTitle": "单选按钮属性", "value": "选定值", "selected": "已勾选", "required": "必选项" },
    ...
    "pastetext":
        { "button": "粘贴为无格式文本", "pasteNotification": "您的浏览器不支持通过工具栏或右键菜单进行粘贴，请按 %1 进行粘贴。", "title": "粘贴为无格式文本" },
    "pastefromword":
    {
    ...
    "easyimage": {
        "commands": { "fullImage": "全宽显示", "sideImage": "侧边显示", "altText": "更改图片代换文字", "upload": "上传图片" },
