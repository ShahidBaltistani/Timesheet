    ...
    CKEDITOR.dialog.add("templates",
        function(c) {
            function r(a, b) {
                ...
                a.image &&
                    b &&
                    (d += '\x3ctd class\x3d"cke_tpl_preview_img"\x3e\x3cimg src\x3d"' +
                        CKEDITOR.getUrl(b + a.image) +
                        '"' +
                        (CKEDITOR.env.ie6Compat ? ' onload\x3d"this.width\x3dthis.width"' : "") +
                        ' alt\x3d"" title\x3d""\x3e\x3c/td\x3e');
                d += '\x3ctd style\x3d"white-space:normal;"\x3e\x3cspan class\x3d"cke_tpl_title"\x3e' +
                    a.title +
            ...
            function t(a) {
                ...
                b.getValueOf("selectTpl", "chkInsertOpt")
                    ? (c.fire("saveSnapshot"), c.setData(a,
                        function() {
                            b.hide();
                            var a = c.createRange();
            ...
            function k(a) {
                var b = a.data.getTarget(), c = g.equals(b);
                if (c || g.contains(b)) {
            ...
            var g, h = "cke_tpl_list_label_" + CKEDITOR.tools.getNextNumber(), f = c.lang.templates, n = c.config;
            return{
                        ...
                        function() {
                            ...
                            if (b.length) {
                                ...
                                for (var d = 0, h = b.length; d < h; d++)
                                    for (var e = CKEDITOR.getTemplates(b[d]),
                                        k = e.imagesPath,
                                        e = e.templates,
                                        q = e.length,
                                        l = 0;
                                ...
                                g.setHtml('\x3cdiv class\x3d"cke_tpl_empty"\x3e\x3cspan\x3e' +
                                    f.emptyListMsg +
