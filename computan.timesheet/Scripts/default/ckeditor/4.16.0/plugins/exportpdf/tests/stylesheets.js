            ...
            bender.test({
                ...
                'test two absolute path custom stylesheets attached to divarea editor': function() {
                    testAttachingStylesheets({
                        ...
                        expectedHtml: '<link type="text/css" rel=stylesheet href="https://ckeditor.css/">' +
                            '<link type="text/css" rel=stylesheet href="https://cksource.css/">' +
                            outputHtml,
                        expectCss: false,
                        extraConfig: {
                ...
                'test one relative path custom stylesheet attached to divarea editor': function() {
                    testAttachingStylesheets({
                        creator: "replace",
                        initialHtml: inputHtml,
                        expectedHtml: '<link type="text/css" rel=stylesheet href="' +
                    ...
                    function(bot) {
                        ...
                        editor.once("exportPdf",
                            function(evt) {
                                ...
                                assert.areEqual(options.expectedHtml, evt.data.html, "HTML is incorrect.");
                            },
                            null,
                            null,
                            16);
