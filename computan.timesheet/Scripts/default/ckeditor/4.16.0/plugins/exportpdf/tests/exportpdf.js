                        ...
                        function(bot) {
                            ...
                            editor.once("exportPdf",
                                function(evt) {
                                    ...
                                    assert.isTrue(CKEDITOR.tools.isEmpty(evt.data.options),
                            ...
                            editor.once("exportPdf",
                                function(evt) {
                                    evt.cancel();
                                    assert.areEqual('<div class="cke_editable cke_contents_ltr">' +
                                        editor.getData() +
                                        "</div>",
                                        evt.data.html,
                    ...
                    bender.editorBot.create({
                        ...
                        function(bot) {
                            if (CKEDITOR.config.exportPdf_isDev) {
                                assert.areEqual(bot.editor.config.exportPdf_service,
                            ...
                            assert.areEqual(bot.editor.config.exportPdf_fileName,
                            ...
                            editor.once("exportPdf",
                                function(evt) {
                                    ...
                                    resume(function() {
                                        warnThrown
                                            ? assert.pass()
                                            : assert.fail("No errors thrown while accessing stylesheets rules.");
                                    });
                                },
                                null,
                                null,
