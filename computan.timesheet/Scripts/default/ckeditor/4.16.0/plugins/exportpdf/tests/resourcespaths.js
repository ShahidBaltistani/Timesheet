...
(function() {
    ...
    CKEDITOR.plugins.load("exportpdf",
        function() {
            bender.test({
                setUp: function() {
                ...
                'test relative (to root) image urls with custom baseHref are changed to absolute': function() {
                    testContentTransformation(
                        ...
                        '" /> Bar <img src="' +
                        exportPdfUtils.toAbsoluteUrl("/img/big/image2.png", "http://ckeditor.com") +
                        '" /></p>',
                        {
                ...
                'test relative (to current url) image urls with ".." are changed to absolute': function() {
                    testContentTransformation(
                        ...
                        '" /> Bar <img src="' +
                        exportPdfUtils.toAbsoluteUrl(this.paths.relative3 + "/img/big/image2.png") +
                        '" /></p>'
                    );
                },
                ...
                'test relative (to current url) image urls with custom baseHref are changed to absolute': function() {
                    testContentTransformation(
                        '<p><img src="img/image1.jpg" /> Bar <img src="img/big/image2.png" /></p>',
                        '<p><img src="' +
                        exportPdfUtils.toAbsoluteUrl("img/image1.jpg", "http://ckeditor.com/ckeditor4/") +
                        '" /> Bar <img src="' +
                        exportPdfUtils.toAbsoluteUrl("img/big/image2.png", "http://ckeditor.com/ckeditor4/") +
                        '" /></p>',
                        {
                            baseHref: "http://ckeditor.com/ckeditor4/"
                        }
                ...
                'test relative (to current url) image urls with custom baseHref and ".." are changed to absolute':
                    function() {
                        testContentTransformation(
                            '<p><img src="../img/image1.jpg" /> Bar <img src="../../img/big/image2.png" /></p>',
                            '<p><img src="' +
                            exportPdfUtils.toAbsoluteUrl("img/image1.jpg", "https://ckeditor.com/ckeditor4/") +
                            '" /> Bar <img src="' +
                            exportPdfUtils.toAbsoluteUrl("img/big/image2.png", "https://ckeditor.com/") +
                            '" /></p>',
                            {
                    ...
                    function(bot) {
                        ...
                        editor.once("exportPdf",
                            function(evt) {
                                ...
                                assert.areEqual('<div class="cke_editable cke_contents_ltr">' + expectedHtml + "</div>",
                                    evt.data.html);
                            },
                            null,
                            null,
