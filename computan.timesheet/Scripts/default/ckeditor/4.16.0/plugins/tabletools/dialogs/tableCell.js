...
CKEDITOR.dialog.add("cellProperties",
    function(h) {
        function k(a) { return{ isSpacer: !0, type: "html", html: "\x26nbsp;", requiredContent: a ? a : void 0 } }

        function r() { return{ type: "vbox", padding: 0, children: [] } }
                ...
                children: [
                    {
                        ...
                        setup: f(function(b) { return u(b, a) })
                    }
                ]
            };
        }
        ...
        function f(a) {
            return function(b) {
                ...
                "undefined" != typeof c &&
                (this.setValue(c), CKEDITOR.env.gecko &&
                    "select" == this.type &&
                    !c &&
        ...
        function v(a, b) {
            h.getColorFromDialog(function(c) {
                    c &&
                        a.getDialog().getContentElement("info",
                            b).setValue(c);
                    a.focus();
                },
                a);
        ...
        var p = h.lang.table,
            ...
            q = [
                t("width"), t("height"), k(["td{width}", "td{height}"]), {
                    type: "select",
                    id: "wordWrap",
                    requiredContent: "td{white-space}",
                    label: d.wordWrap,
                    "default": "yes",
                    items: [[d.yes, "yes"], [d.no, "no"]],
                    setup: f(function(a) {
                    ...
                    "default": "",
                    items: [
                        [e.notSet, ""], [e.left, "left"], [e.center, "center"], [e.right, "right"],
                        [e.justify, "justify"]
                    ],
                    setup: f(function(a) {
                    ...
                    "default": "",
                    items: [
                        [e.notSet, ""], [e.alignTop, "top"], [e.alignMiddle, "middle"], [e.alignBottom, "bottom"],
                ...
                }, k(["td{text-align}", "td{vertical-align}"]),
                {
                    ...
                    label: d.cellType,
                    "default": "td",
                    items: [[d.data, "td"], [d.header, "th"]],
                    setup: f(function(a) { return a.getName() }),
                    ...
                    setup: f(function(a) { if ((a = parseInt(a.getAttribute("rowSpan"), 10)) && 1 != a) return a }),
                    commit: function(a) {
                    ...
                    setup: f(function(a) { if ((a = parseInt(a.getAttribute("colSpan"), 10)) && 1 != a) return a }),
                    commit: function(a) {
                        ...
                        var a = [
                            {
                                ...
                                commit: function(a) { w(this, a, "background-color") }
                            }
                        ];
                        l &&
                            a.push({
                                ...
                                onClick: function() { v(this, "bgColor") }
                            });
                        return a;
                    }()
                }, {
                        ...
                        var a = [
                            {
                                ...
                                commit: function(a) { w(this, a, "border-color") }
                            }
                        ];
                        l &&
                            a.push({
                                ...
                                onClick: function() { v(this, "borderColor") }
                            });
                        return a;
                    }()
                }
            ...
            x = -1,
            g = [r()],
            q = CKEDITOR.tools.array.filter(q,
                function(a) {
        ...
        5 < m && (g = g.concat([k(), r()]));
        CKEDITOR.tools.array.forEach(q,
            function(a) {
                a.isSpacer ||
                    x++;
                5 < m && x >= m / 2 ? g[2].children.push(a) : g[0].children.push(a);
            });
        CKEDITOR.tools.array.forEach(g,
            function(a) { a.isSpacer || (a = a.children, a[a.length - 1].isSpacer && a.pop()) });
        return{
            title: d.title,
            ...
            contents: [
                {
                    ...
                    label: d.title,
                    accessKey: "I",
                    elements: [{ type: "hbox", widths: 1 === g.length ? ["100%"] : ["40%", "5%", "40%"], children: g }]
                }
            ],
            getModel: function(a) { return CKEDITOR.plugins.tabletools.getSelectedCells(a.getSelection()) },
            onShow: function() {
                var a = this.getModel(this.getParentEditor());
                this.setupContent(a);
            },
            onOk: function() {
                for (var a = this._.editor.getSelection(),
                    b = a.createBookmarks(),
                    c = this.getParentEditor(),
                    d = this.getModel(c),
                    e = 0;
                    e < d.length;
                    e++) this.commitContent(d[e]);
            ...
            onLoad: function() {
                ...
                this.foreach(function(b) {
                    b.setup &&
                        b.commit &&
                        (b.setup = CKEDITOR.tools.override(b.setup,
                            function(c) {
                                return function() {
