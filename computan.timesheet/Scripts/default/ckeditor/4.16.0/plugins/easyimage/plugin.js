...
(function() {
    ...
    function addCommands(editor, styles) {
        ...
        function addDefaultCommands() {
            editor.addCommand("easyimageAlt",
        ...
        function addStylesCommands(styles) {
            ...
            editor.on("beforeCommandExec",
                function(evt) {
                    ...
                    if (getStyleNameFromCommand(evt.data.name, styles) &&
                        evt.data.command.style.checkActive(evt.editor.elementPath(), editor)) {
                        evt.cancel();
    ...
    function addContextMenuItems(editor) {
        ...
        CKEDITOR.tools.array.forEach(buttons,
            function(button) {
    ...
    function registerWidget(editor, styles) {
        var config = editor.config,
            ...
            widgetDefinition = {
                ...
                init: function() {
                    ...
                    this.on("uploadStarted",
                        function() {
                            var widget = this;

                            getNaturalWidth(widget.parts.image,
                                function(width) {
                ...
                _loadDefaultStyle: function() {
                    ...
                    for (var styleName in styles) {
                        ...
                        if (!styleMatched &&
                            cmd &&
                            cmd.style &&
                            CKEDITOR.tools.array.indexOf(cmd.style.group, "easyimage") !== -1 &&
                            this.checkStyleActive(cmd.style)) {
                            styleMatched = true;
                        }
                    }
                    ...
                    if (!styleMatched &&
                        defaultStyleName &&
                        editor.getCommand("easyimage" + capitalize(defaultStyleName))) {
        ...
        if (figureClass) {
            ...
            widgetDefinition.allowedContent.figure.classes =
                "!" + figureClass + "," + widgetDefinition.allowedContent.figure.classes;
        }
    ...
    function addPasteListener(editor) {
        var imgWithDataUri =
            new RegExp('<img[^>]*\\ssrc=[\\\'\\"]?data:image/(' + SUPPORTED_IMAGE_TYPES.join("|") + ");base64,", "i");
            ...
            function(evt) {
                ...
                for (i = 0; i < imgs.count(); i++) {
                    ...
                    if (isDataInSrc && isRealObject && !img.isReadOnly(1)) {
                        ...
                        widgetElement = easyImageDef._insertWidget(editor,
                            easyImageDef,
                            imgSrc,
                            false,
                            {
        ...
        editor.addCommand("easyimageUpload",
            {
                exec: function() {
                    ...
                    var hiddenUploadElement =
                        CKEDITOR.dom.element.createFromHtml('<input type="file" accept="image/*" multiple="multiple">');
                    hiddenUploadElement.once("change",
                        function(evt) {
    ...
    CKEDITOR.plugins.add("easyimage",
        {
            ...
            lang:
                "ar,az,bg,cs,da,de,en,en-au,et,fa,fr,gl,hr,hu,it,ku,lv,nb,nl,no,pl,pt,pt-br,ro,ru,sk,sq,sr,sr-latn,sv,tr,tt,uk,zh,zh-cn",
            icons:
                "easyimagefull,easyimageside,easyimagealt,easyimagealignleft,easyimagealigncenter,easyimagealignright,easyimageupload", // %REMOVE_LINE_CORE%
