...
(function() {
    ...
    function c(a, b, c) {
        var h = n[this.id];
        if (h)
            for (var f = "" === this.getValue(), e = this instanceof CKEDITOR.ui.dialog.checkbox, d = 0;
                d < h.length;
                d++) {
                var g = h[d];
                switch (g.type) {
                ...
                case 2:
                    ...
                    if (f || e && m === g["default"]) g.name in c && c[g.name].remove();
                        ...
                        var p = CKEDITOR.dom.element.createFromHtml("\x3ccke:param\x3e\x3c/cke:param\x3e",
                            a.getDocument());
    ...
    for (var n = {
        ...
        k = "play loop menu quality scale salign wmode bgcolor base flashvars allowScriptAccess allowFullScreen"
            .split(" "),
        l = 0;
        l < k.length;
        l++) n[k[l]] = [{ type: 4, name: k[l] }, { type: 2, name: k[l] }];
    k = ["play", "loop", "menu"];
    ...
    CKEDITOR.dialog.add("flash",
        function(a) {
            ...
            return{
                ...
                minHeight: 310,
                getModel: function(a) {
                    return(a = a.getSelection().getSelectedElement()) && "flash" === a.data("cke-real-element-type")
                        ? a
                        : null;
                },
                onShow: function() {
                    ...
                    if (e) {
                        this.fakeImage = e;
                        var d = a.restoreRealElement(e), g = null, b = null, c = {};
                        if ("cke:object" == d.getName()) {
                            ...
                            for (var d = g.getElementsByTag("param", "cke"), f = 0, l = d.count(); f < l; f++) {
                                var k = d.getItem(f), n = k.getAttribute("name"), k = k.getAttribute("value");
                                c[n] = k;
                            }
                ...
                onOk: function() {
                    ...
                    this.fakeImage
                        ...
                        : (l &&
                        (e = CKEDITOR.dom.element.createFromHtml("\x3ccke:object\x3e\x3c/cke:object\x3e",
                            a.document), e.setAttributes({
                    ...
                    if (e)
                        for (var b = {}, c = e.getElementsByTag("param", "cke"), f = 0, h = c.count(); f < h; f++)
                                                    ...
                                                    var a = this.getDialog(),
                                                        b = function(b) {
                                                            ...
                                                            a.preview.setHtml(
                                                                ...
                                                                CKEDITOR.tools.htmlEncode(h.getAttribute("src")) +
                                                                '" type\x3d"application/x-shockwave-flash"\x3e\x3c/embed\x3e');
                                                        };
                                                    a.preview = a.getContentElement("info", "preview").getElement()
                                                        .getChild(3);
                                                    this.on("change",
                                                        function(a) { a.data && a.data.value && b(a.data.value) });
                                                    this.getInputElement().on("change",
                                                        function() { b(this.getValue()) },
                                                        this);
                                                }
                                            },
                                            {
                                ...
                                children: [
                                    {
                                        ...
                                        validate: CKEDITOR.dialog.validate.htmlLength(
                                            a.lang.common.invalidHtmlLength.replace("%1", a.lang.common.width)),
                                        setup: b,
                                        commit: c
                                    },
                                    {
                                        ...
                                        validate: CKEDITOR.dialog.validate.htmlLength(
                                            a.lang.common.invalidHtmlLength.replace("%1", a.lang.common.height)),
                                        setup: b,
                                        commit: c
                                    }, {
                                        type: "text",
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [a.lang.common.notSet, ""], [a.lang.flash.scaleAll, "showall"],
                                    ...
                                    },
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [a.lang.common.notSet, ""], [a.lang.flash.accessAlways, "always"],
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [a.lang.common.notSet, ""], [a.lang.flash.qualityBest, "best"],
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [a.lang.common.notSet, ""], [a.lang.common.left, "left"],
                                            ...
                                            [a.lang.common.alignMiddle, "middle"], [a.lang.common.right, "right"],
                                            [a.lang.flash.alignTextTop, "textTop"], [a.lang.common.alignTop, "top"]
                                        ],
                                        setup: b,
