...
(function() {
    ...
    q.rules = function(c, b, d) {
        function e(a) { (a.attributes["o:gfxdata"] || "v:group" === a.parent.name) && l.push(a.attributes.id) }
            ...
            w = {
                ...
                elements: {
                    a: function(a) {
                        ...
                        a.attributes.name &&
                            A[a.attributes.name] &&
                            (a = A[a.attributes.name], a.attributes.href =
                                a.attributes.href.replace(/.*#(.*)$/, "#$1"));
                    },
                    div: function(a) {
                    ...
                    img: function(a) {
                        ...
                        b = CKEDITOR.tools.array.every(a, function(a) { return-1 < l.indexOf(a) });
                    ...
                    p: function(a) {
                        ...
                        if (g.thisIsAListItem(b, a))
                            p.isEdgeListItem(b, a) && p.cleanupEdgeListItem(a), g.convertToFakeListItem(b, a),
                                n.array.reduce(a.children,
                                    function(a, b) {
                                        "p" === b.name &&
                                        (0 < a && (new CKEDITOR.htmlParser.element("br")).insertBefore(b), b
                                            .replaceWithChildren(), a += 1);
                                        return a;
                                    },
                                    0);
                        else {
                    ...
                    font: function(a) {
                        if (a.getHtml().match(/^\s*$/))
                            return a.parent.type === CKEDITOR.NODE_ELEMENT &&
                                (new CKEDITOR.htmlParser.text(" ")).insertAfter(a), !1;
                        b &&
                    ...
                    ul: function(a) {
                        if (f)
                            return"li" == a.parent.name &&
                                0 === n.indexOf(a.parent.children, a) &&
                                k.setStyle(a.parent, "list-style-type", "none"), g.dissolveList(a), !1;
                    },
                    li: function(a) {
                    ...
                    span: function(a) {
                        ...
                        if (!a.attributes.style ||
                            ...
                            a.getHtml().match(/^(\s|&nbsp;)+$/)) return t.elements.replaceWithChildren(a), !1;
                        a.attributes.style.match(/FONT-FAMILY:\s*Symbol/i) &&
                            a.forEach(function(a) { a.value = a.value.replace(/&nbsp;/g, "") }, CKEDITOR.NODE_TEXT, !0);
                        k.createStyleStack(a, d, b);
                    },
                    "v:imagedata": r,
                    "v:shape": function(a) {
                        ...
                        if (null === a.getFirst("v:imagedata")) e(a);
                            ...
                            "v:group" === a.parent.name
                                ? e(a)
                                : (a.forEach(function(a) { a.attributes && a.attributes.src && (c = a.attributes.src) },
                                    CKEDITOR.NODE_ELEMENT,
                                    !0), a.filterChildren(d), a.name = "img", a.attributes.src =
                                    a.attributes.src || c, delete a.attributes.type);
                        }
                    },
                    style: function() { return!1 },
                    object: function(a) { return!(!a.attributes || !a.attributes.data) },
                    br: function(a) {
                        if (b.plugins.pagebreak &&
                        (a = n.parseCssText(a.attributes.style, !0), "always" === a["page-break-before"] ||
                            "page" === a["break-before"]))
                            return a =
                                CKEDITOR.plugins.pagebreak.createElement(b), CKEDITOR.htmlParser.fragment
                                .fromHtml(a.getOuterHtml()).children[0];
                    }
                },
                attributes: {
        ...
        n.array.forEach(E, function(a) { w.elements[a] = e });
        return w;
    };
    q.lists = {
        ...
        convertToFakeListItem: function(c, b) {
            ...
            if (!b.attributes["cke-dissolved"]) {
                ...
                b.forEach(function(b) {
                    ...
                    CKEDITOR.NODE_ELEMENT);
                b.forEach(function(b) { d || b.value.match(/^ /) || (d = b.value) }, CKEDITOR.NODE_TEXT);
        ...
        convertToRealListItems: function(c) {
            var b = [];
            c.forEach(function(c) { "cke:li" == c.name && (c.name = "li", b.push(c)) }, CKEDITOR.NODE_ELEMENT, !1);
            return b;
        },
        removeSymbolText: function(c) {
            var b = c.attributes["cke-symbol"],
                d = c.findOne(function(c) { return c.value && -1 < c.value.indexOf(b) }, !0),
                e;
            d &&
            (d.value = d.value.replace(b, ""), e = d.parent, e.getHtml().match(/^(\s|&nbsp;)*$/) &&
                e !== c
                ? e.remove()
                : d.value || d.remove());
        },
        setListSymbol: function(c, b, d) {
            ...
            if ("ol" == c.name) {
                ...
                f = { "·": "disc", o: "circle", "§": "square" }, !e["list-style-type"] &&
                    f[b] &&
            ...
            toNumber: function(c, b) {
                function d(b) {
                    ...
                    for (var c = 1, d = 1; 0 < b.length; d *= 26)
                        c += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(b.charAt(b.length - 1)) * d, b =
                ...
                function e(b) {
                    var c = [
                        [1E3, "M"], [900, "CM"], [500, "D"], [400, "CD"], [100, "C"], [90, "XC"], [
                            50,
                            "L"
        ...
        getSubsectionSymbol: function(c) { return(c.match(/([\da-zA-Z]+).?$/) || ["placeholder", "1"])[1] },
                ...
                for (f = 0; f < a.length; f++) {
                    ...
                    for (e = d.attributes["cke-list-level"]; e > h.length;) {
                        ...
                        0 < x.length
                            ? x[x.length - 1].add(v)
                            : (x =
                                new CKEDITOR.htmlParser.element("li", { style: "list-style-type:none" }), x.add(v), m
                                .add(x));
                        h.push(v);
                        u.push(v);
                        m = v;
                    ...
                    for (; e < h.length;)
                        h.pop(), m =
                            h[h.length - 1], e == h.length && g.setListSymbol(m, d.attributes["cke-symbol"], e);
                    d.remove();
                    m.add(d);
                }
                h[0].children.length &&
                (f = h[0].children[0].attributes["cke-symbol"], !f &&
                    1 < h[0].children.length &&
                    (f = h[0].children[1].attributes["cke-symbol"]), f && g.setListSymbol(h[0], f));
                for (f = 0; f < u.length; f++) g.setListStart(u[f]);
                for (f = 0; f < a.length; f++) this.determineListItemValue(a[f]);
            }
            CKEDITOR.tools.array.forEach(l,
                function(a) {
                    for (var c = [], d = a.parent; d;) "li" === d.name && c.push(d), d = d.parent;
                    var c = b(c), e;
                    c &&
                    (a.attributes = a.attributes || {}, d = CKEDITOR.tools.parseCssText(a.attributes.style), e =
                        d["margin-left"] ||
                        0, (e = Math.max(parseInt(e, 10) - c, 0))
                        ? d["margin-left"] = e + "px"
                        : delete d["margin-left"], a.attributes.style = CKEDITOR.tools.writeCssText(d));
                });
            return l;
        },
        cleanup: function(c) {
        ...
        determineListItemValue: function(c) {
            if ("ol" === c.parent.name) {
                ...
                d &&
                (d = d[d.length - 1], e = c.parent.attributes["cke-list-style-type"] ||
        ...
        dissolveList: function(c) {
            ...
            var e = function(b) { return function(a) { return a.name == b } },
                f = function(b) { return e("ul")(b) || e("ol")(b) },
                g = CKEDITOR.tools.array,
                w = [],
                a,
                h;
            c.forEach(function(b) { w.push(b) }, CKEDITOR.NODE_ELEMENT, !1);
            a = g.filter(w, e("li"));
            var m = g.filter(w, f);
            g.forEach(m,
                function(a) {
                    ...
                    g.forEach(g.filter(a.children, e("li")),
                        function(d, e) {
                            var f;
                            switch (c) {
                            case "disc":
        ...
        chopDiscontinuousLists: function(c, b) {
            for (var d = {}, e = [[]], f, l = 0; l < c.length; l++) {
                ...
                k
                    ? (m = k.type.match(/alpha/) && 7 == k.index ? "alpha" : m, m =
                        "o" == c[l].attributes["cke-symbol"] && 14 == k.index ? "alpha" : m, h =
                        g.getSymbolInfo(c[l].attributes["cke-symbol"], m), a =
                        this.getListItemInfo(c[l]), (k.type != h.type ||
    ...
    q.heuristics = {
        isEdgeListItem: function(c, b) {
            ...
            var d = "";
            b.forEach && b.forEach(function(b) { d += b.value }, CKEDITOR.NODE_TEXT);
        ...
        isDegenerateListItem: function(c, b) {
            return!!b.attributes["cke-list-level"] ||
                b.attributes.style &&
                !b.attributes.style.match(/mso\-list/) &&
                !!b.find(function(c) {
                        if (c.type == CKEDITOR.NODE_ELEMENT &&
                            b.name.match(/h\d/i) &&
                            c.getHtml().match(/^[a-zA-Z0-9]+?[\.\)]$/)) return!0;
        ...
        assignListLevels: function(c, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                for (var d = [z(b)], e = [b], f = [], g = CKEDITOR.tools.array, k = g.map;
                    b.next &&
                        b.next.attributes &&
                        !b.next.attributes["cke-list-level"] &&
                        p.isDegenerateListItem(c, b.next);
                ) b = b.next, d.push(z(b)), e.push(b);
                var a = k(d, function(a, b) { return 0 === b ? 0 : a - d[b - 1] }),
                    h = this.guessIndentationStep(g.filter(d,
                        function(a) { return 0 !== a })),
                    f = k(d, function(a) { return Math.round(a / h) });
                -1 !== g.indexOf(f, 0) && (f = k(f, function(a) { return a + 1 }));
                g.forEach(e, function(a, b) { a.attributes["cke-list-level"] = f[b] });
                return{ indents: d, levels: f, diffs: a };
            }
        },
        guessIndentationStep: function(c) { return c.length ? Math.min.apply(null, c) : null },
        correctLevelShift: function(c) {
            if (this.isShifted(c)) {
                var b = CKEDITOR.tools.array.filter(c.children, function(b) { return"ul" == b.name || "ol" == b.name }),
                    d = CKEDITOR.tools.array.reduce(b,
                        function(b, c) {
                            return(c.children &&
                                1 == c.children.length &&
                        ...
                        []);
                CKEDITOR.tools.array.forEach(b, function(b) { b.remove() });
                CKEDITOR.tools.array.forEach(d, function(b) { c.add(b) });
                delete c.name;
            }
        },
        isShifted: function(c) {
            return"li" !== c.name
                ? !1
                : 0 ===
                CKEDITOR.tools.array.filter(c.children,
                    function(b) {
