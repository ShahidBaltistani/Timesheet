    ...
    function q(a, m) {
        function r() {
            this.foreach(function(a) {
                ...
                (a.setup || (a.setup = function(c) { a.setValue(c.getAttribute(a.id) || "", 1) }), a.commit ||
                (a.commit = function(c) {
                    var f = this.getValue();
        ...
        return{
                            ...
                            children: [
                                {
                                    ...
                                    onChange: function() {
                                        var g = [
                                            ...
                                            c = this.getDialog(),
                                            f = c.getModel(a),
                                            f = f && f.clone() || new CKEDITOR.dom.element("div", a.document);
                                        this.commit(f, !0);
                                        for (var g = [].concat(g), b = g.length, k, e = 0; e < b; e++)
                                            (k = c.getContentElement.apply(c, g[e].split(":"))) &&
                                                k.setup &&
                                                k.setup(f, !0);
                                    },
                                    setup: function(g) {
                                        for (var c in n) n[c].checkElementRemovable(g, !0, a) && this.setValue(c, 1);
                                    },
                                    commit: function(g) {
                                        var c;
                                        (c = this.getValue()) ? n[c].applyToObject(g, a) : g.removeAttribute("style");
                                    }
                                }, {
                                    id: "class",
                                    type: "text",
                    ...
                    elements: [
                        {
                            ...
                            children: [
                                ...
                                },
                                {
                                    ...
                                    "default": "",
                                    items: [
                                        [a.lang.common.notSet, ""], [a.lang.common.langDirLtr, "ltr"],
            ...
            getModel: function(a) { return"editdiv" === m ? CKEDITOR.plugins.div.getSurroundDiv(a) : null },
            onLoad: function() {
                r.call(this);
                var g = this, c = this.getContentElement("info", "elementStyle");
                    ...
                    if (f)
                        for (var e = 0; e < f.length; e++)
                            k = f[e], k.element &&
                                "div" == k.element &&
                                (b = k.name, n[b] = k =
                                    new CKEDITOR.style(k), a.filter.check(k) && (c.items.push([b, b]), c.add(b, b)));
            ...
            onShow: function() { "editdiv" == m && this.setupContent(this.getModel(a)) },
            onOk: function() {
                if ("editdiv" == m) p = [this.getModel(a)];
                    ...
                    for (l = 0; l < f.length; l++)
                        b = f[l], d =
                                a.elementPath(b).blockLimit, d.isReadOnly() && (d = d.getParent()),
                            a.config.div_wrapTable &&
                                d.is(["td", "th"]) &&
                                (d = a.elementPath(d.getParent()).blockLimit), d.equals(h) || (h = d, e.push([])),
                    ...
                    for (h = 0; h < e.length; h++)
                        if (e[h].length) {
                            ...
                            for (b = 0; b < e[h].length; b++) {
                                for (d = e[h][b]; d.getParent() && !d.getParent().equals(f);) d = d.getParent();
                                e[h][b] = d;
                            }
                            for (b = 0; b < e[h].length; b++)
                                d = e[h][b], d.getCustomData && d.getCustomData("block_processed") ||
                                (d.is && CKEDITOR.dom.element.setMarker(c, d, "block_processed", !0), b ||
                                    l.insertBefore(d), l.append(d));
                            CKEDITOR.dom.element.clearAllMarkers(c);
                            g.push(l);
                        }
                    k.selectBookmarks(n);
            ...
            onHide: function() {
                this.getMode(a) === CKEDITOR.dialog.EDITING_MODE && this.getModel(a).removeCustomData("elementStyle");
            }
        };
    }
