    ...
    var u = function(d, k) {
        ...
        var l = /^\s*(\d+)((px)|\%)?\s*$/i,
            ...
            z = function() {
                ...
                c && ("%" == c[2] && m(b, !1), a = c[1]);
                b.lockRatio &&
                (c = b.originalElement, "true" == c.getCustomData("isReady") &&
                ("txtHeight" == this.id
                    ? (a && "0" != a && (a = Math.round(a / c.$.height * c.$.width)),
                        isNaN(a) || b.setValueOf("info", "txtWidth", a))
                    : (a && "0" != a && (a = Math.round(a / c.$.width * c.$.height)), isNaN(a) ||
        ...
        return{
            ...
            onShow: function() {
                ...
                c &&
                (this.linkElement = c, this.addLink = this.linkEditMode =
                    !0, a = c.getChildren(), 1 == a.count() &&
                (d = a.getItem(0), d.type == CKEDITOR.NODE_ELEMENT &&
                    (d.is("img") || d.is("input")) &&
                    (this.imageElement = a.getItem(0), this.imageElement.is("img")
                        ? this.imageEditMode = "img"
                        : this.imageElement.is("input") && (this.imageEditMode = "input"))), "image" == k &&
                    this.setupContent(2, c));
                if (this.customImageElement)
                    this.imageEditMode = "img", this.imageElement =
                        this.customImageElement, delete this.customImageElement;
                else if (b && "img" == b.getName() && !b.data("cke-realelement") ||
                    b &&
                    "input" == b.getName() &&
                ...
                (this.cleanImageElement = this.imageElement, this.imageElement =
                    this.cleanImageElement.clone(!0, !0), this.setupContent(1, this.imageElement));
                m(this, !0);
            ...
            onOk: function() {
                if (this.imageEditMode) {
                    ...
                    "image" == k && "input" == a && confirm(d.lang.image.button2Img)
                        ? (this.imageElement =
                                d.document.createElement("img"), this.imageElement.setAttribute("alt", ""),
                            d.insertElement(this.imageElement))
                        : "image" != k && "img" == a && confirm(d.lang.image.img2Button)
                        ? (this.imageElement =
                                d.document.createElement("input"),
                            this.imageElement.setAttributes({ type: "image", alt: "" }), d.insertElement(
                                this.imageElement))
            ...
            onHide: function() {
                ...
                (this.originalElement.removeListener("load", t), this.originalElement.removeListener("error", f),
                    this.originalElement.removeListener("abort", f), this.originalElement.remove(),
            ...
            contents: [
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            setup: function(a, b) { 1 == a && this.setValue(b.getAttribute("alt")) },
                            commit: function(a, b) {
                                1 == a
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            validate: function() {
                                                                ...
                                                                (a = !(!a || 0 === parseInt(a[1], 10))) ||
                                                                    alert(d.lang.common.invalidLength
                                                            ...
                                                            commit: function(a,
                                                                ...
                                                                var c = this.getValue();
                                                                1 == a
                                                                    ? (c && d.activeFilter.check("img{width,height}")
                                                                            ? b.setStyle("width",
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    validate: CKEDITOR.dialog.validate.integer(d.lang.image
                                                        .validateBorder),
                                                    setup: function(a, b) {
                                                        if (1 == a) {
                                                            var c;
                                                            c = (c = (c = b.getStyle("border-width")) &&
                                                                    c.match(/^(\d+px)(?: \1 \1 \1)?$/)) &&
                                                                parseInt(c[1], 10);
                                                        ...
                                                        1 == a || 4 == a
                                                            ? (isNaN(c)
                                                                ...
                                                                : (b.setStyle("border-width",
                                                                    ...
                                                                    "border-style",
                                                                    "solid")), 1 == a && b.removeAttribute("border"))
                                                            : 8 == a &&
                                                            (b.removeAttribute("border"), b.removeStyle("border-width"),
                                                                b.removeStyle("border-style"), b.removeStyle(
                                                                    "border-color"))
                                                    }
                                                }, {
                                                    type: "text",
                                                        ...
                                                        1 == a || 4 == a
                                                            ? (isNaN(c)
                                                                ...
                                                                : (b.setStyle("margin-left",
                                                                    CKEDITOR.tools.cssLength(c)), b.setStyle(
                                                                    "margin-right",
                                                                    CKEDITOR.tools.cssLength(c))), 1 == a &&
                                                    ...
                                                    "default": "",
                                                    items: [
                                                        [d.lang.common.notSet, ""], [d.lang.common.left, "left"],
                    ...
                    elements: [
                            ...
                            children: [
                                {
                                    ...
                                    setup: function(a, b) { 1 == a && this.setValue(b.getAttribute("id")) },
                                    commit: function(a, b) {
                                        1 == a &&
                                            (this.getValue() || this.isChanged()) &&
                                ...
                                },
                                {
                                    ...
                                    "default": "",
                                    setup: function(a, b) { 1 == a && this.setValue(b.getAttribute("lang")) },
                                    commit: function(a, b) {
                                        1 == a &&
                                            (this.getValue() || this.isChanged()) &&
                        ...
                        },
                        {
                            ...
                            setup: function(a, b) { 1 == a && this.setValue(b.getAttribute("longDesc")) },
                            commit: function(a, b) {
                                1 == a &&
                                    (this.getValue() || this.isChanged()) &&
                            ...
                            children: [
                                ...
                                },
                                {
                                    ...
                                    "default": "",
                                    onChange: function() { e(this.getDialog()) },
                                    setup: function(a, b) { 1 == a && this.setValue(b.getAttribute("title")) },
                                    commit: function(a, b) {
                                        1 == a
                                            ? (this.getValue() || this.isChanged()) &&
