...
(function() {
    function d(c) {
        ...
        c.hasAttribute(this.id) &&
            (c = c.getAttribute(this.id), e ? this.setValue(g[this.id]["true"] == c.toLowerCase()) : this.setValue(c));
    }
    ...
    CKEDITOR.dialog.add("iframe",
        function(c) {
            var e = c.lang.iframe, a = c.lang.common, g = c.plugins.dialogadvtab;
            return{
                title: e.title,
                minWidth: 350,
                minHeight: 260,
                getModel: function(b) {
                    return(b = b.getSelection().getSelectedElement()) && "iframe" === b.data("cke-real-element-type")
                        ? b
                        : null;
                },
                onShow: function() {
                    ...
                    b &&
                        ...
                        (this.fakeImage = b, this.iframeNode = b = c.restoreRealElement(b), this.setupContent(b));
                },
                onOk: function() {
                    var b;
                        ...
                        elements: [
                            {
                                ...
                                children: [
                                    ...
                                    },
                                    {
                                        ...
                                        "default": "",
                                        items: [
                                            [a.notSet, ""], [a.left, "left"], [a.right, "right"], [a.alignTop, "top"],
                                            [a.alignMiddle, "middle"], [a.alignBottom, "bottom"]
                                        ],
                                        style: "width:100%",
                                        labelLayout: "vertical",
                                        label: a.align,
