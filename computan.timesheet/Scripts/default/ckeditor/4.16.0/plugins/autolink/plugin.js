                ...
                editor.on("key",
                    function(evt) {
                        if (editor.mode !== "wysiwyg" ||
                            CKEDITOR.tools.indexOf(editor.config.autolink_commitKeystrokes, evt.data.keyCode) == -1) {
                            return;
                        }

                        var matched =
                            CKEDITOR.plugins.textMatch.match(editor.getSelection().getRanges()[0], matchCallback);
