...
*/
CKEDITOR.dialog.add("colordialog",
    function(w) {
        function l() {
        ...
        function y(a) {
            ...
            "td" == a.getName() &&
                ...
                (x(), e = a, e.setAttribute("aria-selected", !0), e.addClass("cke_colordialog_selected"), m
                    .getContentElement("picker", "selectedColor").setValue(c));
        }

        function x() { e && (e.removeClass("cke_colordialog_selected"), e.removeAttribute("aria-selected"), e = null) }
        ...
        function z(a) {
            ...
            var c = !/mouse/.test(a.name), b = a.data.getTarget(), f;
            "td" == b.getName() &&
                (f = b.getChild(0).getHtml()) &&
                (q(a), c ? d = b : A = b, c &&
                    b.addClass(D(f) ? "cke_colordialog_focused_light" : "cke_colordialog_focused_dark"), r(f));
        }
        ...
        function q(a) {
            if (a = !/mouse/.test(a.name) && d)
                a.removeClass("cke_colordialog_focused_light"), a.removeClass("cke_colordialog_focused_dark");
            d || A || r(!1);
        }
        ...
        function E(a) {
            var c = a.data, b = c.getTarget(), f = c.getKeystroke(), d = "rtl" == w.lang.dir;
            switch (f) {
            case 38:
        ...
        (function() {
            function a(a, d) {
                for (var e = a; e < a + 3; e++) {
                    ...
                    for (var g = d; g < d + 3; g++) for (var h = 0; 6 > h; h++) c(f.$, "#" + b[g] + b[h] + b[e]);
                }
            }
            ...
            function c(a, c) {
                ...
                b.append(CKEDITOR.dom.element.createFromHtml(
                    '\x3cspan id\x3d"' + d + '" class\x3d"cke_voice_label"\x3e' + c + "\x3c/span\x3e",
                    CKEDITOR.document));
            }
        ...
        CKEDITOR.document.appendStyleSheet(CKEDITOR.getUrl(CKEDITOR.plugins.get("colordialog").path +
        ...
        return{
            ...
            minHeight: 220,
            onShow: function(a) {
                if (!a.data.selectionColor ||
                    a.data.selectionColor == a.data.automaticTextColor ||
                    "#rgba(0, 0, 0, 0)" == a.data.selectionColor && "back" == a.data.type) l(), B();
                else {
                            ...
                            children: [
                                {
                                    ...
                                    onLoad: function() { CKEDITOR.document.getById(this.domId).append(k) },
                                    focus: function() {
                                    ...
                                    children: [
                                        {
                                            ...
                                            onChange: function() {
                                                try {
                                                    h.getById(p).setStyle("background-color", this.getValue());
                                                } catch (a) {
                                                    l();
                                                }
                                            }
                                        }, C, { type: "button", id: "clear", label: g.clear, onClick: l }
                                    ]
                                }
                            ]
                        }
