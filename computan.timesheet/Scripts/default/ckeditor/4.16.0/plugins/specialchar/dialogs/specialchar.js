    ...
    function(h) {
        ...
        l = function(c) {
            ...
            "a" == c.getName() &&
                ...
                (c.removeClass("cke_light_background"), f.hide(), c =
                    h.document.createElement("span"), c.setHtml(b), h.insertText(c.getText()));
        };
        ...
        d = function(c, b) {
            ...
            "span" == b.getName() && (b = b.getParent());
            "a" == b.getName() &&
            (f.getContentElement("info", "charPreview").getElement().setHtml("\x26nbsp;"), f
                    .getContentElement("info", "htmlPreview").getElement()
                    .setHtml("\x26nbsp;"), b.getParent().removeClass("cke_light_background"),
                k = void 0);
        };
        ...
        return{
            ...
            onLoad: function() {
                ...
                d.push("\x3c/tbody\x3e\x3c/table\x3e",
