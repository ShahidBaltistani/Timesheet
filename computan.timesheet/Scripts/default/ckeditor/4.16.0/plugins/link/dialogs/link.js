    ...
    CKEDITOR.dialog.add("link",
        function(c) {
            ...
            var n = CKEDITOR.plugins.link,
                ...
                d = function(a) { a.target && this.setValue(a.target[this.id] || "") },
                g = function(a) {
                    a.advanced &&
            ...
            return{
                ...
                minHeight: 240,
                getModel: function(a) { return n.getSelectedLink(a, !0)[0] || null },
                contents: [
                    {
                        id: "info",
                        label: b.info,
                        ...
                        elements: [
                            {
                                ...
                                "default": "url",
                                items: [
                                    [b.toUrl, "url"], [b.toAnchor, "anchor"], [b.toEmail, "email"], [b.toPhone, "tel"]
                                ],
                                onChange: function() {
                                    var a = this.getDialog(),
                                    ...
                                    "url" == r
                                        ? (c.config.linkShowTargetTab &&
                                            a.showPage("target"), f || a.showPage("upload"))
                                        : (a.hidePage("target"), f || a.hidePage("upload"));
                                    for (f = 0; f < b.length; f++) {
                                        var m = a.getContentElement("info", b[f]);
                                        m &&
                                        (m = m.getElement().getParent().getParent(), b[f] == r + "Options"
                                            ? m.show()
                                            : m.hide());
                                    }
                                    a.layout();
                                        ...
                                        children: [
                                            {
                                                ...
                                                onKeyUp: function() {
                                                    ...
                                                    f
                                                        ? (this.setValue(b.substr(f[0].length)), a.setValue(
                                                            f[0].toLowerCase()))
                                                        : c.test(b) && a.setValue("");
                                ...
                                children: [
                                    {
                                        ...
                                        html: '\x3cdiv role\x3d"note" tabIndex\x3d"-1"\x3e' +
                                            ...
                                            "\x3c/div\x3e",
                                        focus: !0,
                                        setup: function() { this.getElement()[l && l.length ? "hide" : "show"]() }
                                    }
                                ],
                                setup: function() {
                                ...
                                children: [
                                    {
                                        ...
                                        style: "width : 100%;",
                                        items: [
                                            [h.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"],
                                            [h.targetNew, "_blank"], [h.targetTop, "_top"], [h.targetSelf, "_self"],
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            ...
                                            },
                                            {
                                                ...
                                                "default": "",
                                                style: "width:110px",
                                                items: [[h.notSet, ""], [b.langDirLTR, "ltr"], [b.langDirRTL, "rtl"]],
                                                setup: g,
                                                commit: k
                                            },
                                            {
                                        ...
                                        children: [
                                            {
                                                ...
                                                "default": "",
                                                id: "advStyles",
                                                validate: CKEDITOR.dialog.validate.inlineStyle(c.lang.common
                                                    .invalidInlineStyle),
                                                setup: g,
                                                commit: k
                                            }
                ...
                onOk: function() {
                    ...
                    if (this._.selectedElements.length) {
                        var b = this._.selectedElements, h = n.getLinkAttributes(c, a), f = [], m, l, d, g, e, k;
                        ...
                        for (g = 0;
                            ...
                            d.collapsed
                                ? (e =
                                    new CKEDITOR.dom.text(a.linkText ||
                                        ("email" == a.type ? a.email.address : b.set["data-cke-saved-href"]),
                                        c.document), d.insertNode(e), d.selectNodeContents(e))
                                : q !== a.linkText &&
                                (e = new CKEDITOR.dom.text(a.linkText, c.document), d.shrink(CKEDITOR.SHRINK_TEXT), c
                                    .editable().extractHtmlFromRange(d), d.insertNode(e));
                            e = d._find("a");
