...
(function() {
    ...
    function v(c) {
        return!(c.type == CKEDITOR.NODE_ELEMENT &&
            c.isBlockBoundary(CKEDITOR.tools.extend({}, CKEDITOR.dtd.$empty, CKEDITOR.dtd.$nonEditable)));
    }
    ...
    var m,
        ...
        q = [
            ["txtFindFind", "txtFindReplace"], [
                "txtFindCaseChk",
                "txtReplaceCaseChk"
            ], ["txtFindWordChk", "txtReplaceWordChk"], ["txtFindCyclic", "txtReplaceCyclic"]
        ];
        ...
        function(c) {
            ...
            t.prototype = {
                toDomRange: function() {
                    ...
                    if (1 > b.length) {
                        ...
                        d = b[0], b =
                            b[b.length - 1], a.setStart(d.textNode, d.offset), a.setEnd(b.textNode, b.offset + 1);
                    return a;
                },
                ...
                feedCharacter: function(a) {
                    for (this._.ignoreCase && (a = a.toLowerCase());;) {
                        if (a == this._.pattern.charAt(this._.state))
                            return this._.state++, this._.state == this._.pattern.length ? (this._.state = 0, 2) : 1;
            ...
            var E = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
                ...
                f = {
                    ...
                    find: function(a, b, d, e, D, u) {
                        this.matchRange
                            ? (this.matchRange.removeHighlight(), this.matchRange =
                        ...
                        return e && !u
                            ? (this.searchRange = r(1), this.matchRange =
                                null, f.find.apply(this, Array.prototype.slice.call(arguments).concat([!0])))
                            : !1;
                    },
                    replaceCounter: 0,
                    replace: function(a, b, d, e, f, u, h) {
                        ...
                        if (!this.matchRange ||
                            ...
                            a &&
                                    this.matchRange &&
                                    (this.matchRange.clearMatched(), this.matchRange.removeHighlight(),
            ...
            return{
                                ...
                                children: [
                                    {
                                        ...
                                        onClick: function() {
                                            ...
                                            f.find(a.getValueOf("find", "txtFindFind"),
                                ...
                                children: [
                                    {
                                        ...
                                        onClick: function() {
                                            ...
                                            f.replaceCounter
                                                ? (alert(e.replaceSuccessMsg.replace(/%1/, f.replaceCounter)), c.fire(
                                                    "saveSnapshot"))
                                                : alert(e.notFoundMsg);
                                        }
                                    }
                ...
                onLoad: function() {
                    ...
                    this.selectPage = CKEDITOR.tools.override(this.selectPage,
                        function(c) {
                            return function(e) {
                                c.call(a, e);
                                var f = a._.tabs[e], h;
                                ...
                                if (d) {
                                    ...
                                    for (l = 0; l < g; l++)
                                        h = this.getContentElement(x[e],
                                            q[l][e]), k =
                                            this.getContentElement(x[f], q[l][f]), k.setValue(h.getValue());
                                }
                            };
                        });
                },
                ...
                onHide: function() {
                    ...
                    f.matchRange &&
                        ...
                        (f.matchRange.removeHighlight(), (a = f.matchRange.toDomRange()) &&
