...
CKEDITOR.dialog.add("checkbox",
    function(d) {
        return{
            ...
            minHeight: 140,
            getModel: function(a) {
                return(a = a.getSelection().getSelectedElement()) && "checkbox" == a.getAttribute("type") ? a : null;
            },
            onShow: function() {
            ...
            onOk: function() {
                var a = this.getParentEditor(), b = this.getModel(a);
                b || (b = a.document.createElement("input"), b.setAttribute("type", "checkbox"), a.insertElement(b));
                    ...
                    elements: [
                        {
                            ...
                            commit: function(a) {
                                ...
                                !c || CKEDITOR.env.ie && "on" == c
                                    ? CKEDITOR.env.ie
                                    ? (c =
                                            new CKEDITOR.dom.element("input", b.getDocument()),
                                        b.copyAttributes(c, { value: 1 }), c.replace(b), d.getSelection()
                                            .selectElement(c),
                                        a.element = c)
                            ...
                            commit: function(a) {
                                ...
                                if (CKEDITOR.env.ie) {
                                    ...
                                    c != e &&
                                    (c = CKEDITOR.dom.element.createFromHtml('\x3cinput type\x3d"checkbox"' +
                                        (e ? ' checked\x3d"checked"' : "") +
                                        "/\x3e",
                                        d.document), b.copyAttributes(c, { type: 1, checked: 1 }), c.replace(b), d
                                        .getSelection().selectElement(c), a.element = c);
                                } else
                                    a = this.getValue(), CKEDITOR.env.webkit && (b.$.checked = a), a
