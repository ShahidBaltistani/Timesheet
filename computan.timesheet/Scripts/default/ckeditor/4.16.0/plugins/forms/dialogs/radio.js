    ...
    function(c) {
        return{
            ...
            onOk: function() {
                ...
                b || (b = a.document.createElement("input"), b.setAttribute("type", "radio"), a.insertElement(b));
                    ...
                    elements: [
                        {
                            ...
                            commit: function(a) {
                                var b = a.element;
                                if (CKEDITOR.env.ie) {
                                    var d = b.getAttribute("checked"), e = !!this.getValue();
                                    d != e &&
                                    (d = CKEDITOR.dom.element.createFromHtml('\x3cinput type\x3d"radio"' +
                                        (e ? ' checked\x3d"checked"' : "") +
                                        "\x3e\x3c/input\x3e",
                                        c.document), b.copyAttributes(d, { type: 1, checked: 1 }), d.replace(b), e &&
                                        d.setAttribute("checked", "checked"), c.getSelection().selectElement(d), a
                                        .element = d);
                                } else
