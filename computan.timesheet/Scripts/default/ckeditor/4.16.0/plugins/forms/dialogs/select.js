    ...
    function(c) {
        function h(a, b, e, d, c) {
            ...
            if (a && d && "option" == d.getName())
                CKEDITOR.env.ie
                    ? (isNaN(parseInt(c, 10)) ? a.$.options.add(d.$) : a.$.options.add(d.$, c), d.$.innerHTML =
                        0 < b.length ? b : "", d.$.value = e)
                    : (null !== c && c < a.getChildCount() ? a.getChild(0 > c ? 0 : c).insertBeforeMe(d) : a.append(d),
                        d.setText(0 < b.length ? b : ""), d.setValue(e));
            else return!1;
            return d;
        }
        ...
        function p(a) {
            a = f(a);
            for (var b = g(a), e = a.getChildren().count() - 1;
                0 <=
                    e;
                e--) a.getChild(e).$.selected && a.getChild(e).remove();
            k(a, b);
        }
        ...
        function l(a, b, e) {
            ...
            if (d == b) return!1;
            var d = a.getChild(d), c = d.getText(), r = d.getValue();
            d.remove();
        ...
        return{
            ...
            getModel: function(a) {
                return(a = a.getSelection().getSelectedElement()) && "select" == a.getName() ? a : null;
            },
            onShow: function() {
                this.setupContent("clear");
                var a =
                    this.getModel(this.getParentEditor());
                if (a) {
                                    ...
                                    children: [
                                        {
                                            ...
                                            style: "width:115px",
                                            setup: function(a) { "clear" == a && this.setValue("") }
                                        }, {
                                            type: "select",
                                            id: "cmbName",
                                            label: "",
                                            ...
                                            setup: function(a, b) {
                                                if ("clear" == a) m(this);
                                                    ...
                                                    "selected" == b.getAttribute("selected") &&
                                                        this.getDialog().getContentElement("info", "txtValue")
                                                        .setValue(e);
                                                }
                                            }
                                        }
                                    ...
                                    children: [
                                        {
                                            ...
                                            onClick: function() {
                                                var a = this.getDialog(),
                                                    ...
                                                    c = g(d);
                                                0 <= c &&
                                                (q(d, c, b.getValue(), b.getValue()), q(a,
                                                    c,
                                                    e.getValue(),
                                                    e.getValue()));
                                            }
                                    ...
                                    children: [
                                        {
                                            ...
                                            setup: function(a, b) {
                                                "select" == a &&
                                                    CKEDITOR.plugins.forms._setupRequiredAttribute.call(this,
                                                        b);
                                            },
                                            commit: function(a) {
                                                this.getValue()
