        ...
        return{
            ...
            onOk: function() {
                var a = this.getValueOf("info", "_cke_saved_name"),
                    ...
                    a = CKEDITOR.env.ie && 8 > CKEDITOR.document.$.documentMode
                        ? b.document.createElement('\x3cinput name\x3d"' + CKEDITOR.tools.htmlEncode(a) + '"\x3e')
                        : b.document.createElement("input");
                a.setAttribute("type", "hidden");
                this.commitContent(a);
                var a = b.createFakeElement(a, "cke_hidden", "hiddenfield"), c = this.getModel(b);
