...
CKEDITOR.dialog.add("textarea",
    function(b) {
        return{
            ...
            minHeight: 220,
            getModel: function(a) {
                return(a = a.getSelection().getSelectedElement()) && "textarea" == a.getName() ? a : null;
            },
            onShow: function() {
            ...
            contents: [
                {
                    ...
                    elements: [
                            ...
                            children: [
                                {
                                    ...
                                    setup: function(a) {
                                        a =
                                            a.hasAttribute("rows") && a.getAttribute("rows");
                                        this.setValue(a || "");
                                    },
                                    commit: function(a) {
                                        this.getValue()
                        ...
                        },
                        {
                            ...
                            "default": "",
                            setup: function(a) { this.setValue(a.$.defaultValue) },
                            commit: function(a) { a.$.value = a.$.defaultValue = this.getValue() }
                        }, {
                            id: "required",
                            type: "checkbox",
