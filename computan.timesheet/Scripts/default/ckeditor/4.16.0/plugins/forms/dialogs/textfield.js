    ...
    function(b) {
        ...
        return{
            ...
            getModel: function(a) {
                ...
                return!a || "input" != a.getName() || !g[a.getAttribute("type")] && a.getAttribute("type") ? null : a;
            },
            onShow: function() {
            ...
            onLoad: function() {
                this.foreach(function(a) { a.getValue && (a.setup || (a.setup = f), a.commit || (a.commit = e)) });
            },
            contents: [
                {
                    id: "info",
                    ...
                    elements: [
                        {
                            ...
                            children: [
                                {
                                    ...
                                    commit: function(a) {
                                        if (CKEDITOR.env.ie && !this.getValue()) {
                                            var d = a.element, c = new CKEDITOR.dom.element("input", b.document);
                            ...
                            items: [
                                ...
                                [b.lang.forms.textfield.typeSearch, "search"], [b.lang.forms.textfield.typeTel, "tel"],
                                [
                                    b.lang.forms.textfield.typeText,
                                    "text"
                            ...
                            commit: function(a) {
                                var d = a.element;
                                if (CKEDITOR.env.ie) {
                                    var c = d.getAttribute("type"), e = this.getValue();
                                    c != e &&
                                    (c = CKEDITOR.dom.element.createFromHtml(
                                        '\x3cinput type\x3d"' + e + '"\x3e\x3c/input\x3e',
                                        b.document), d.copyAttributes(c, { type: 1 }), c.replace(d), a.element = c);
