 ...
 */
CKEDITOR.dialog.add("base64imageDialog",
    function(editor) {
        ...
        function imagePreviewLoad(s) {
            ...
            i.onload = function() {
                ...
                this.setAttribute("style", "max-height:100px; max-width:400px;");
        ...
        return {
            ...
            onLoad: function() {
                ...
                this.getContentElement("tab-properties", "lock").getInputElement().on("click",
                    function() {
                ...
                this.getContentElement("tab-properties", "width").getInputElement()
                    .on("keyup", function() { if (lock) imageDimensions("width"); });
                this.getContentElement("tab-properties", "height").getInputElement()
                    .on("keyup", function() { if (lock) imageDimensions("height"); });
                this.getContentElement("tab-properties", "vmargin").getInputElement().on("keyup",
                    function() { integerValue(this); },
                    this.getContentElement("tab-properties", "vmargin"));
                this.getContentElement("tab-properties", "hmargin").getInputElement().on("keyup",
                    function() { integerValue(this); },
            ...
            onOk: function() {
                ...
                newImg.setAttribute("alt",
                    t.getValueOf("tab-properties", "alt").replace(/^\s+/, "").replace(/\s+$/, ""));
                var attr = {
