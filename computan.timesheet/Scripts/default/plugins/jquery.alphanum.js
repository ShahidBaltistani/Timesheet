    ...
    function setupEventHandlers($textboxes, trimFunction, settings) {
        ...
        $textboxes.each(function() {
            ...
            $textbox
                ...
                .off(".alphanum")
                .on("keyup.alphanum change.alphanum paste.alphanum",
                    function(e) {
                ...
                .on("keypress.alphanum",
                    function(e) {
                        ...
                        var potentialTextAfterKeypress = textBeforeKeypress.substring(0, start) +
                            newChar +
...
(function(e) {
    var t = function(e) {
            return e.replace(/([a-z])([a-z]+)/gi, function(e, t, n) { return t + n.toLowerCase() }).replace(/_/g, "");
        },
        n = function(e) { return e.replace(/^([a-z]+)_TO_([a-z]+)/i, function(e, t, n) { return n + "_TO_" + t }) },
        r = function(e) { return e ? e.ownerDocument.defaultView || e.ownerDocument.parentWindow : window },
        i = function(t, n) {
