(function(factory) {
    ...
    var ColorpickerEmbed = function(element) {
        ...
        var inputGrp =
            $(
                '<div class="input-group input-group-sm"><input type="text" class="form-control"/><span class="input-group-btn"><button class="btn btn-default" type="button" title="Custom Color">C</button></span></div>');
    ...
    */
    ...
    var ColorpickerPlus = function(element, options) {
        ...
        var input = $element.is("input") ? $element : (this.options.input ? $element.find(this.options.input) : false);
